...
`,[c$1(">",[cB("scrollbar-container",`
 ...
 `,[fadeInTransition(),c$1("&:hover",{backgroundColor:"var(--n-scrollbar-color-hover)"})])])])])]),scrollbarProps=Object.assign(Object.assign({},useTheme.props),{size:{type:Number,default:5},duration:{type:Number,default:0},scrollable:{type:Boolean,default:!0},xScrollable:Boolean,trigger:{type:String,default:"hover"},useUnifiedContainer:Boolean,triggerDisplayManually:Boolean,container:Function,content:Function,containerClass:String,containerStyle:[String,Object],contentClass:String,contentStyle:[String,Object],horizontalRailStyle:[String,Object],verticalRailStyle:[String,Object],onScroll:Function,onWheel:Function,onResize:Function,internalOnUpdateScrollLeft:Function,internalHoistYRail:Boolean}),Scrollbar=defineComponent({name:"Scrollbar",props:scrollbarProps,inheritAttrs:!1,setup(e){const{mergedClsPrefixRef:n,inlineThemeDisabled:t,mergedRtlRef:o}=useConfig(e),r=useRtl("Scrollbar",o,n),i=ref(null),a=ref(null),s=ref(null),l=ref(null),d=ref(null),u=ref(null),f=ref(null),b=ref(null),C=ref(null),g=ref(null),w=ref(null),y=ref(0),v=ref(0),k=ref(!1),_=ref(!1);let A=!1,$=!1,M,x,T=0,I=0,O=0,V=0;const z=useIsIos(),Y=computed(()=>{const{value:J}=b,{value:ae}=u,{value:fe}=g;return J===null||ae===null||fe===null?0:Math.min(J,fe*J/ae+e.size*1.5)}),L=computed(()=>`${Y.value}px`),H=computed(()=>{const{value:J}=C,{value:ae}=f,{value:fe}=w;return J===null||ae===null||fe===null?0:fe*J/ae+e.size*1.5}),te=computed(()=>`${H.value}px`),j=computed(()=>{const{value:J}=b,{value:ae}=y,{value:fe}=u,{value:ve}=g;if(J===null||fe===null||ve===null)return 0;{const ke=fe-J;return ke?ae/ke*(ve-Y.value):0}}),ee=computed(()=>`${j.value}px`),R=computed(()=>{const{value:J}=C,{value:ae}=v,{value:fe}=f,{value:ve}=w;if(J===null||fe===null||ve===null)return 0;{const ke=fe-J;return ke?ae/ke*(ve-H.value):0}}),G=computed(()=>`${R.value}px`),pe=computed(()=>{const{value:J}=b,{value:ae}=u;return J!==null&&ae!==null&&ae>J}),me=computed(()=>{const{value:J}=C,{value:ae}=f;return J!==null&&ae!==null&&ae>J}),Le=computed(()=>{const{trigger:J}=e;return J==="none"||k.value}),Ce=computed(()=>{const{trigger:J}=e;return J==="none"||_.value}),ye=computed(()=>{const{container:J}=e;return J?J():a.value}),de=computed(()=>{const{content:J}=e;return J?J():s.value}),ge=useReactivated(()=>{e.container||Ke({top:y.value,left:v.value})}),Ve=()=>{ge.isDeactivated||X()},he=J=>{if(ge.isDeactivated)return;const{onResize:ae}=e;ae&&ae(J),X()},Ke=(J,ae)=>{if(!e.scrollable)return;if(typeof J=="number"){P(ae??0,J,0,!1,"auto");return}const{left:fe,top:ve,index:ke,elSize:ze,position:He,behavior:Ae,el:je,debounce:Ie=!0}=J;(fe!==void 0||ve!==void 0)&&P(fe??0,ve??0,0,!1,Ae),je!==void 0?P(0,je.offsetTop,je.offsetHeight,Ie,Ae):ke!==void 0&&ze!==void 0?P(0,ke*ze,ze,Ie,Ae):He==="bottom"?P(0,Number.MAX_SAFE_INTEGER,0,!1,Ae):He==="top"&&P(0,0,0,!1,Ae)},Pe=(J,ae)=>{if(!e.scrollable)return;const{value:fe}=ye;fe&&(typeof J=="object"?fe.scrollBy(J):fe.scrollBy(J,ae||0))};function P(J,ae,fe,ve,ke){const{value:ze}=ye;if(ze){if(ve){const{scrollTop:He,offsetHeight:Ae}=ze;if(ae>He){ae+fe<=He+Ae||ze.scrollTo({left:J,top:ae+fe-Ae,behavior:ke});return}}ze.scrollTo({left:J,top:ae,behavior:ke})}}function E(){oe(),Q(),X()}function F(){K()}function K(){q(),ne()}function q(){x!==void 0&&window.clearTimeout(x),x=window.setTimeout(()=>{_.value=!1},e.duration)}function ne(){M!==void 0&&window.clearTimeout(M),M=window.setTimeout(()=>{k.value=!1},e.duration)}function oe(){M!==void 0&&window.clearTimeout(M),k.value=!0}function Q(){x!==void 0&&window.clearTimeout(x),_.value=!0}function Z(J){const{onScroll:ae}=e;ae&&ae(J),W()}function W(){const{value:J}=ye;J&&(y.value=J.scrollTop,v.value=J.scrollLeft*(r!=null&&r.value?-1:1))}function ce(){const{value:J}=de;J&&(u.value=J.offsetHeight,f.value=J.offsetWidth);const{value:ae}=ye;ae&&(b.value=ae.offsetHeight,C.value=ae.offsetWidth);const{value:fe}=d,{value:ve}=l;fe&&(w.value=fe.offsetWidth),ve&&(g.value=ve.offsetHeight)}function se(){const{value:J}=ye;J&&(y.value=J.scrollTop,v.value=J.scrollLeft*(r!=null&&r.value?-1:1),b.value=J.offsetHeight,C.value=J.offsetWidth,u.value=J.scrollHeight,f.value=J.scrollWidth);const{value:ae}=d,{value:fe}=l;ae&&(w.value=ae.offsetWidth),fe&&(g.value=fe.offsetHeight)}function X(){e.scrollable&&(e.useUnifiedContainer?se():(ce(),W()))}function ie(J){var ae;return!(!((ae=i.value)===null||ae===void 0)&&ae.contains(getPreciseEventTarget(J)))}function le(J){J.preventDefault(),J.stopPropagation(),$=!0,on("mousemove",window,Se,!0),on("mouseup",window,be,!0),I=v.value,O=r!=null&&r.value?window.innerWidth-J.clientX:J.clientX}function Se(J){if(!$)return;M!==void 0&&window.clearTimeout(M),x!==void 0&&window.clearTimeout(x);const{value:ae}=C,{value:fe}=f,{value:ve}=H;if(ae===null||fe===null)return;const ze=(r!=null&&r.value?window.innerWidth-J.clientX-O:J.clientX-O)*(fe-ae)/(ae-ve),He=fe-ae;let Ae=I+ze;Ae=Math.min(He,Ae),Ae=Math.max(Ae,0);const{value:je}=ye;if(je){je.scrollLeft=Ae*(r!=null&&r.value?-1:1);const{internalOnUpdateScrollLeft:Ie}=e;Ie&&Ie(Ae)}}function be(J){J.preventDefault(),J.stopPropagation(),off("mousemove",window,Se,!0),off("mouseup",window,be,!0),$=!1,X(),ie(J)&&K()}function Te(J){J.preventDefault(),J.stopPropagation(),A=!0,on("mousemove",window,Ee,!0),on("mouseup",window,Ge,!0),T=y.value,V=J.clientY}function Ee(J){if(!A)return;M!==void 0&&window.clearTimeout(M),x!==void 0&&window.clearTimeout(x);const{value:ae}=b,{value:fe}=u,{value:ve}=Y;if(ae===null||fe===null)return;const ze=(J.clientY-V)*(fe-ae)/(ae-ve),He=fe-ae;let Ae=T+ze;Ae=Math.min(He,Ae),Ae=Math.max(Ae,0);const{value:je}=ye;je&&(je.scrollTop=Ae)}function Ge(J){J.preventDefault(),J.stopPropagation(),off("mousemove",window,Ee,!0),off("mouseup",window,Ge,!0),A=!1,X(),ie(J)&&K()}watchEffect(()=>{const{value:J}=me,{value:ae}=pe,{value:fe}=n,{value:ve}=d,{value:ke}=l;ve&&(J?ve.classList.remove(`${fe}-scrollbar-rail--disabled`):ve.classList.add(`${fe}-scrollbar-rail--disabled`)),ke&&(ae?ke.classList.remove(`${fe}-scrollbar-rail--disabled`):ke.classList.add(`${fe}-scrollbar-rail--disabled`))}),onMounted(()=>{e.container||X()}),onBeforeUnmount(()=>{M!==void 0&&window.clearTimeout(M),x!==void 0&&window.clearTimeout(x),off("mousemove",window,Ee,!0),off("mouseup",window,Ge,!0)});const Qe=useTheme("Scrollbar","-scrollbar",style$j,scrollbarLight$1,e,n),Je=computed(()=>{const{common:{cubicBezierEaseInOut:J,scrollbarBorderRadius:ae,scrollbarHeight:fe,scrollbarWidth:ve},self:{color:ke,colorHover:ze}}=Qe.value;return{"--n-scrollbar-bezier":J,"--n-scrollbar-color":ke,"--n-scrollbar-color-hover":ze,"--n-scrollbar-border-radius":ae,"--n-scrollbar-width":ve,"--n-scrollbar-height":fe}}),qe=t?useThemeClass("scrollbar",void 0,Je,e):void 0;return Object.assign(Object.assign({},{scrollTo:Ke,scrollBy:Pe,sync:X,syncUnifiedContainer:se,handleMouseEnterWrapper:E,handleMouseLeaveWrapper:F}),{mergedClsPrefix:n,rtlEnabled:r,containerScrollTop:y,wrapperRef:i,containerRef:a,contentRef:s,yRailRef:l,xRailRef:d,needYBar:pe,needXBar:me,yBarSizePx:L,xBarSizePx:te,yBarTopPx:ee,xBarLeftPx:G,isShowXBar:Le,isShowYBar:Ce,isIos:z,handleScroll:Z,handleContentResize:Ve,handleContainerResize:he,handleYScrollMouseDown:Te,handleXScrollMouseDown:le,cssVars:t?void 0:Je,themeClass:qe==null?void 0:qe.themeClass,onRender:qe==null?void 0:qe.onRender})},render(){var e;const{$slots:n,mergedClsPrefix:t,triggerDisplayManually:o,rtlEnabled:r,internalHoistYRail:i}=this;if(!this.scrollable)return(e=n.default)===null||e===void 0?void 0:e.call(n);const a=this.trigger==="none",s=()=>h("div",{ref:"yRailRef",class:[`${t}-scrollbar-rail`,`${t}-scrollbar-rail--vertical`],"data-scrollbar-rail":!0,style:this.verticalRailStyle,"aria-hidden":!0},h(a?Wrapper:Transition,a?null:{name:"fade-in-transition"},{default:()=>this.needYBar&&this.isShowYBar&&!this.isIos?h("div",{class:`${t}-scrollbar-rail__scrollbar`,style:{height:this.yBarSizePx,top:this.yBarTopPx},onMousedown:this.handleYScrollMouseDown}):null})),l=()=>{var u,f;return(u=this.onRender)===null||u===void 0||u.call(this),h("div",mergeProps(this.$attrs,{role:"none",ref:"wrapperRef",class:[`${t}-scrollbar`,this.themeClass,r&&`${t}-scrollbar--rtl`],style:this.cssVars,onMouseenter:o?void 0:this.handleMouseEnterWrapper,onMouseleave:o?void 0:this.handleMouseLeaveWrapper}),[this.container?(f=n.default)===null||f===void 0?void 0:f.call(n):h("div",{role:"none",ref:"containerRef",class:[`${t}-scrollbar-container`,this.containerClass],style:this.containerStyle,onScroll:this.handleScroll,onWheel:this.onWheel},h(VResizeObserver,{onResize:this.handleContentResize},{default:()=>h("div",{ref:"contentRef",role:"none",style:[{width:this.xScrollable?"fit-content":null},this.contentStyle],class:[`${t}-scrollbar-content`,this.contentClass]},n)})),i?null:s(),this.xScrollable&&h("div",{ref:"xRailRef",class:[`${t}-scrollbar-rail`,`${t}-scrollbar-rail--horizontal`],style:this.horizontalRailStyle,"data-scrollbar-rail":!0,"aria-hidden":!0},h(a?Wrapper:Transition,a?null:{name:"fade-in-transition"},{default:()=>this.needXBar&&this.isShowXBar&&!this.isIos?h("div",{class:`${t}-scrollbar-rail__scrollbar`,style:{width:this.xBarSizePx,right:r?this.xBarLeftPx:void 0,left:r?void 0:this.xBarLeftPx},onMousedown:this.handleXScrollMouseDown}):null}))])},d=this.container?l():h(VResizeObserver,{onResize:this.handleContainerResize},{default:l});return i?h(Fragment,null,d,s()):d}}),NScrollbar=Scrollbar,XScrollbar=Scrollbar,commonVariables$l={height:"calc(var(--n-option-height) * 7.6)",paddingSmall:"4px 0",paddingMedium:"4px 0",paddingLarge:"4px 0",paddingHuge:"4px 0",optionPaddingSmall:"0 12px",optionPaddingMedium:"0 12px",optionPaddingLarge:"0 12px",optionPaddingHuge:"0 12px",loadingSize:"18px"},self$R=e=>{const{borderRadius:n,popoverColor:t,textColor3:o,dividerColor:r,textColor2:i,primaryColorPressed:a,textColorDisabled:s,primaryColor:l,opacityDisabled:d,hoverColor:u,fontSizeSmall:f,fontSizeMedium:b,fontSizeLarge:C,fontSizeHuge:g,heightSmall:w,heightMedium:y,heightLarge:v,heightHuge:k}=e;return Object.assign(Object.assign({},commonVariables$l),{optionFontSizeSmall:f,optionFontSizeMedium:b,optionFontSizeLarge:C,optionFontSizeHuge:g,optionHeightSmall:w,optionHeightMedium:y,optionHeightLarge:v,optionHeightHuge:k,borderRadius:n,color:t,groupHeaderTextColor:o,actionDividerColor:r,optionTextColor:i,optionTextColorPressed:a,optionTextColorDisabled:s,optionTextColorActive:l,optionOpacityDisabled:d,optionCheckColor:l,optionColorPending:u,optionColorActive:"rgba(0, 0, 0, 0)",optionColorActivePending:u,actionTextColor:i,loadingColor:l})},internalSelectMenuDark={name:"InternalSelectMenu",common:commonDark,peers:{Scrollbar:scrollbarDark$1,Empty:emptyDark$1},self:self$R},internalSelectMenuDark$1=internalSelectMenuDark,{cubicBezierEaseIn:cubicBezierEaseIn$1,cubicBezierEaseOut:cubicBezierEaseOut$1}=commonVariables$m;function fadeInScaleUpTransition({transformOrigin:e="inherit",duration:n=".2s",enterScale:t=".9",originalTransform:o="",originalTransition:r=""}={}){return[c$1("&.fade-in-scale-up-transition-leave-active",{transformOrigin:e,transition:`opacity ${n} ${cubicBezierEaseIn$1}, transform ${n} ${cubicBezierEaseIn$1} ${r&&","+r}`}),c$1("&.fade-in-scale-up-transition-enter-active",{transformOrigin:e,transition:`opacity ${n} ${cubicBezierEaseOut$1}, transform ${n} ${cubicBezierEaseOut$1} ${r&&","+r}`}),c$1("&.fade-in-scale-up-transition-enter-from, &.fade-in-scale-up-transition-leave-to",{opacity:0,transform:`${o} scale(${t})`}),c$1("&.fade-in-scale-up-transition-leave-from, &.fade-in-scale-up-transition-enter-to",{opacity:1,transform:`${o} scale(1)`})]}const style$i=cB("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),NBaseWave=defineComponent({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){useStyle("-base-wave",style$i,toRef(e,"clsPrefix"));const n=ref(null),t=ref(!1);let o=null;return onBeforeUnmount(()=>{o!==null&&window.clearTimeout(o)}),{active:t,selfRef:n,play(){o!==null&&(window.clearTimeout(o),t.value=!1,o=null),nextTick(()=>{var r;(r=n.value)===null||r===void 0||r.offsetHeight,t.value=!0,o=window.setTimeout(()=>{t.value=!1,o=null},1e3)})}}},render(){const{clsPrefix:e}=this;return h("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),commonVariables$k={space:"6px",spaceArrow:"10px",arrowOffset:"10px",arrowOffsetVertical:"10px",arrowHeight:"6px",padding:"8px 14px"},self$Q=e=>{const{boxShadow2:n,popoverColor:t,textColor2:o,borderRadius:r,fontSize:i,dividerColor:a}=e;return Object.assign(Object.assign({},commonVariables$k),{fontSize:i,borderRadius:r,color:t,dividerColor:a,textColor:o,boxShadow:n})},popoverLight={name:"Popover",common:commonLight,self:self$Q},popoverLight$1=popoverLight,popoverDark={name:"Popover",common:commonDark,self:self$Q},popoverDark$1=popoverDark,oppositePlacement={top:"bottom",bottom:"top",left:"right",right:"left"},arrowSize="var(--n-arrow-height) * 1.414",style$h=c$1([cB("popover",`
 ...
 ${o}
 `,[cB("popover-arrow",n)])])])}const popoverBodyProps=Object.assign(Object.assign({},useTheme.props),{to:useAdjustedTo.propTo,show:Boolean,trigger:String,showArrow:Boolean,delay:Number,duration:Number,raw:Boolean,arrowPointToCenter:Boolean,arrowStyle:[String,Object],displayDirective:String,x:Number,y:Number,flip:Boolean,overlap:Boolean,placement:String,width:[Number,String],keepAliveOnHover:Boolean,scrollable:Boolean,contentStyle:[Object,String],headerStyle:[Object,String],footerStyle:[Object,String],internalDeactivateImmediately:Boolean,animated:Boolean,onClickoutside:Function,internalTrapFocus:Boolean,internalOnAfterLeave:Function,minWidth:Number,maxWidth:Number}),renderArrow=({arrowStyle:e,clsPrefix:n})=>h("div",{key:"__popover-arrow__",class:`${n}-popover-arrow-wrapper`},h("div",{class:`${n}-popover-arrow`,style:e})),NPopoverBody=defineComponent({name:"PopoverBody",inheritAttrs:!1,props:popoverBodyProps,setup(e,{slots:n,attrs:t}){const{namespaceRef:o,mergedClsPrefixRef:r,inlineThemeDisabled:i}=useConfig(e),a=useTheme("Popover","-popover",style$h,popoverLight$1,e,r),s=ref(null),l=inject("NPopover"),d=ref(null),u=ref(e.show),f=ref(!1);watchEffect(()=>{const{show:x}=e;x&&!isJsdom()&&!e.internalDeactivateImmediately&&(f.value=!0)});const b=computed(()=>{const{trigger:x,onClickoutside:T}=e,I=[],{positionManuallyRef:{value:O}}=l;return O||(x==="click"&&!T&&I.push([clickoutside$1,A,void 0,{capture:!0}]),x==="hover"&&I.push([mousemoveoutside$1,_])),T&&I.push([clickoutside$1,A,void 0,{capture:!0}]),(e.displayDirective==="show"||e.animated&&f.value)&&I.push([vShow,e.show]),I}),C=computed(()=>{const x=e.width==="trigger"?void 0:formatLength(e.width),T=[];x&&T.push({width:x});const{maxWidth:I,minWidth:O}=e;return I&&T.push({maxWidth:formatLength(I)}),O&&T.push({maxWidth:formatLength(O)}),i||T.push(g.value),T}),g=computed(()=>{const{common:{cubicBezierEaseInOut:x,cubicBezierEaseIn:T,cubicBezierEaseOut:I},self:{space:O,spaceArrow:V,padding:z,fontSize:Y,textColor:L,dividerColor:H,color:te,boxShadow:j,borderRadius:ee,arrowHeight:R,arrowOffset:G,arrowOffsetVertical:pe}}=a.value;return{"--n-box-shadow":j,"--n-bezier":x,"--n-bezier-ease-in":T,"--n-bezier-ease-out":I,"--n-font-size":Y,"--n-text-color":L,"--n-color":te,"--n-divider-color":H,"--n-border-radius":ee,"--n-arrow-height":R,"--n-arrow-offset":G,"--n-arrow-offset-vertical":pe,"--n-padding":z,"--n-space":O,"--n-space-arrow":V}}),w=i?useThemeClass("popover",void 0,g,e):void 0;l.setBodyInstance({syncPosition:y}),onBeforeUnmount(()=>{l.setBodyInstance(null)}),watch(toRef(e,"show"),x=>{e.animated||(x?u.value=!0:u.value=!1)});function y(){var x;(x=s.value)===null||x===void 0||x.syncPosition()}function v(x){e.trigger==="hover"&&e.keepAliveOnHover&&e.show&&l.handleMouseEnter(x)}function k(x){e.trigger==="hover"&&e.keepAliveOnHover&&l.handleMouseLeave(x)}function _(x){e.trigger==="hover"&&!$().contains(getPreciseEventTarget(x))&&l.handleMouseMoveOutside(x)}function A(x){(e.trigger==="click"&&!$().contains(getPreciseEventTarget(x))||e.onClickoutside)&&l.handleClickOutside(x)}function $(){return l.getTriggerElement()}provide(popoverBodyInjectionKey,d),provide(drawerBodyInjectionKey,null),provide(modalBodyInjectionKey,null);function M(){if(w==null||w.onRender(),!(e.displayDirective==="show"||e.show||e.animated&&f.value))return null;let T;const I=l.internalRenderBodyRef.value,{value:O}=r;if(I)T=I([`${O}-popover-shared`,w==null?void 0:w.themeClass.value,e.overlap&&`${O}-popover-shared--overlap`,e.showArrow&&`${O}-popover-shared--show-arrow`,e.arrowPointToCenter&&`${O}-popover-shared--center-arrow`],d,C.value,v,k);else{const{value:V}=l.extraClassRef,{internalTrapFocus:z}=e,Y=!isSlotEmpty(n.header)||!isSlotEmpty(n.footer),L=()=>{var H;const te=Y?h(Fragment,null,resolveWrappedSlot(n.header,R=>R?h("div",{class:`${O}-popover__header`,style:e.headerStyle},R):null),resolveWrappedSlot(n.default,R=>R?h("div",{class:`${O}-popover__content`,style:e.contentStyle},n):null),resolveWrappedSlot(n.footer,R=>R?h("div",{class:`${O}-popover__footer`,style:e.footerStyle},R):null)):e.scrollable?(H=n.default)===null||H===void 0?void 0:H.call(n):h("div",{class:`${O}-popover__content`,style:e.contentStyle},n),j=e.scrollable?h(XScrollbar,{contentClass:Y?void 0:`${O}-popover__content`,contentStyle:Y?void 0:e.contentStyle},{default:()=>te}):te,ee=e.showArrow?renderArrow({arrowStyle:e.arrowStyle,clsPrefix:O}):null;return[j,ee]};T=h("div",mergeProps({class:[`${O}-popover`,`${O}-popover-shared`,w==null?void 0:w.themeClass.value,V.map(H=>`${O}-${H}`),{[`${O}-popover--scrollable`]:e.scrollable,[`${O}-popover--show-header-or-footer`]:Y,[`${O}-popover--raw`]:e.raw,[`${O}-popover-shared--overlap`]:e.overlap,[`${O}-popover-shared--show-arrow`]:e.showArrow,[`${O}-popover-shared--center-arrow`]:e.arrowPointToCenter}],ref:d,style:C.value,onKeydown:l.handleKeydown,onMouseenter:v,onMouseleave:k},t),z?h(FocusTrap,{active:e.show,autoFocus:!0},{default:L}):L())}return withDirectives(T,b.value)}return{displayed:f,namespace:o,isMounted:l.isMountedRef,zIndex:l.zIndexRef,followerRef:s,adjustedTo:useAdjustedTo(e),followerEnabled:u,renderContentNode:M}},render(){return h(VFollower,{ref:"followerRef",zIndex:this.zIndex,show:this.show,enabled:this.followerEnabled,to:this.adjustedTo,x:this.x,y:this.y,flip:this.flip,placement:this.placement,containerClass:this.namespace,overlap:this.overlap,width:this.width==="trigger"?"target":void 0,teleportDisabled:this.adjustedTo===useAdjustedTo.tdkey},{default:()=>this.animated?h(Transition,{name:"popover-transition",appear:this.isMounted,onEnter:()=>{this.followerEnabled=!0},onAfterLeave:()=>{var e;(e=this.internalOnAfterLeave)===null||e===void 0||e.call(this),this.followerEnabled=!1,this.displayed=!1}},{default:this.renderContentNode}):this.renderContentNode()})}}),bodyPropKeys=Object.keys(popoverBodyProps),triggerEventMap={focus:["onFocus","onBlur"],click:["onClick"],hover:["onMouseenter","onMouseleave"],manual:[],nested:["onFocus","onBlur","onMouseenter","onMouseleave","onClick"]};function appendEvents(e,n,t){triggerEventMap[n].forEach(o=>{e.props?e.props=Object.assign({},e.props):e.props={};const r=e.props[o],i=t[o];r?e.props[o]=(...a)=>{r(...a),i(...a)}:e.props[o]=i})}const textVNodeType=createTextVNode("").type,popoverBaseProps={show:{type:Boolean,default:void 0},defaultShow:Boolean,showArrow:{type:Boolean,default:!0},trigger:{type:String,default:"hover"},delay:{type:Number,default:100},duration:{type:Number,default:100},raw:Boolean,placement:{type:String,default:"top"},x:Number,y:Number,arrowPointToCenter:Boolean,disabled:Boolean,getDisabled:Function,displayDirective:{type:String,default:"if"},arrowStyle:[String,Object],flip:{type:Boolean,default:!0},animated:{type:Boolean,default:!0},width:{type:[Number,String],default:void 0},overlap:Boolean,keepAliveOnHover:{type:Boolean,default:!0},zIndex:Number,to:useAdjustedTo.propTo,scrollable:Boolean,contentStyle:[Object,String],headerStyle:[Object,String],footerStyle:[Object,String],onClickoutside:Function,"onUpdate:show":[Function,Array],onUpdateShow:[Function,Array],internalDeactivateImmediately:Boolean,internalSyncTargetWithParent:Boolean,internalInheritedEventHandlers:{type:Array,default:()=>[]},internalTrapFocus:Boolean,internalExtraClass:{type:Array,default:()=>[]},onShow:[Function,Array],onHide:[Function,Array],arrow:{type:Boolean,default:void 0},minWidth:Number,maxWidth:Number},popoverProps=Object.assign(Object.assign(Object.assign({},useTheme.props),popoverBaseProps),{internalOnAfterLeave:Function,internalRenderBody:Function}),NPopover=defineComponent({name:"Popover",inheritAttrs:!1,props:popoverProps,__popover__:!0,setup(e){const n=isMounted(),t=ref(null),o=computed(()=>e.show),r=ref(e.defaultShow),i=useMergedState(o,r),a=useMemo(()=>e.disabled?!1:i.value),s=()=>{if(e.disabled)return!0;const{getDisabled:L}=e;return!!(L!=null&&L())},l=()=>s()?!1:i.value,d=useCompitable(e,["arrow","showArrow"]),u=computed(()=>e.overlap?!1:d.value);let f=null;const b=ref(null),C=ref(null),g=useMemo(()=>e.x!==void 0&&e.y!==void 0);function w(L){const{"onUpdate:show":H,onUpdateShow:te,onShow:j,onHide:ee}=e;r.value=L,H&&call(H,L),te&&call(te,L),L&&j&&call(j,!0),L&&ee&&call(ee,!1)}function y(){f&&f.syncPosition()}function v(){const{value:L}=b;L&&(window.clearTimeout(L),b.value=null)}function k(){const{value:L}=C;L&&(window.clearTimeout(L),C.value=null)}function _(){const L=s();if(e.trigger==="focus"&&!L){if(l())return;w(!0)}}function A(){const L=s();if(e.trigger==="focus"&&!L){if(!l())return;w(!1)}}function $(){const L=s();if(e.trigger==="hover"&&!L){if(k(),b.value!==null||l())return;const H=()=>{w(!0),b.value=null},{delay:te}=e;te===0?H():b.value=window.setTimeout(H,te)}}function M(){const L=s();if(e.trigger==="hover"&&!L){if(v(),C.value!==null||!l())return;const H=()=>{w(!1),C.value=null},{duration:te}=e;te===0?H():C.value=window.setTimeout(H,te)}}function x(){M()}function T(L){var H;l()&&(e.trigger==="click"&&(v(),k(),w(!1)),(H=e.onClickoutside)===null||H===void 0||H.call(e,L))}function I(){if(e.trigger==="click"&&!s()){v(),k();const L=!l();w(L)}}function O(L){e.internalTrapFocus&&L.key==="Escape"&&(v(),k(),w(!1))}function V(L){r.value=L}function z(){var L;return(L=t.value)===null||L===void 0?void 0:L.targetRef}function Y(L){f=L}return provide("NPopover",{getTriggerElement:z,handleKeydown:O,handleMouseEnter:$,handleMouseLeave:M,handleClickOutside:T,handleMouseMoveOutside:x,setBodyInstance:Y,positionManuallyRef:g,isMountedRef:n,zIndexRef:toRef(e,"zIndex"),extraClassRef:toRef(e,"internalExtraClass"),internalRenderBodyRef:toRef(e,"internalRenderBody")}),watchEffect(()=>{i.value&&s()&&w(!1)}),{binderInstRef:t,positionManually:g,mergedShowConsideringDisabledProp:a,uncontrolledShow:r,mergedShowArrow:u,getMergedShow:l,setShow:V,handleClick:I,handleMouseEnter:$,handleMouseLeave:M,handleFocus:_,handleBlur:A,syncPosition:y}},render(){var e;const{positionManually:n,$slots:t}=this;let o,r=!1;if(!n&&(t.activator?o=getFirstSlotVNode(t,"activator"):o=getFirstSlotVNode(t,"trigger"),o)){o=cloneVNode(o),o=o.type===textVNodeType?h("span",[o]):o;const i={onClick:this.handleClick,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onFocus:this.handleFocus,onBlur:this.handleBlur};if(!((e=o.type)===null||e===void 0)&&e.__popover__)r=!0,o.props||(o.props={internalSyncTargetWithParent:!0,internalInheritedEventHandlers:[]}),o.props.internalSyncTargetWithParent=!0,o.props.internalInheritedEventHandlers?o.props.internalInheritedEventHandlers=[i,...o.props.internalInheritedEventHandlers]:o.props.internalInheritedEventHandlers=[i];else{const{internalInheritedEventHandlers:a}=this,s=[i,...a],l={onBlur:d=>{s.forEach(u=>{u.onBlur(d)})},onFocus:d=>{s.forEach(u=>{u.onFocus(d)})},onClick:d=>{s.forEach(u=>{u.onClick(d)})},onMouseenter:d=>{s.forEach(u=>{u.onMouseenter(d)})},onMouseleave:d=>{s.forEach(u=>{u.onMouseleave(d)})}};appendEvents(o,a?"nested":n?"manual":this.trigger,l)}}return h(VBinder,{ref:"binderInstRef",syncTarget:!r,syncTargetWithParent:this.internalSyncTargetWithParent},{default:()=>{this.mergedShowConsideringDisabledProp;const i=this.getMergedShow();return[this.internalTrapFocus&&i?withDirectives(h("div",{style:{position:"fixed",inset:0}}),[[zindexable$1,{enabled:i,zIndex:this.zIndex}]]):null,n?null:h(VTarget,null,{default:()=>o}),h(NPopoverBody,keep(this.$props,bodyPropKeys,Object.assign(Object.assign({},this.$attrs),{showArrow:this.mergedShowArrow,show:i})),{default:()=>{var a,s;return(s=(a=this.$slots).default)===null||s===void 0?void 0:s.call(a)},header:()=>{var a,s;return(s=(a=this.$slots).header)===null||s===void 0?void 0:s.call(a)},footer:()=>{var a,s;return(s=(a=this.$slots).footer)===null||s===void 0?void 0:s.call(a)}})]}})}}),commonVariables$j={closeIconSizeTiny:"12px",closeIconSizeSmall:"12px",closeIconSizeMedium:"14px",closeIconSizeLarge:"14px",closeSizeTiny:"16px",closeSizeSmall:"16px",closeSizeMedium:"18px",closeSizeLarge:"18px",padding:"0 7px",closeMargin:"0 0 0 4px",closeMarginRtl:"0 4px 0 0"},tagDark={name:"Tag",common:commonDark,self(e){const{textColor2:n,primaryColorHover:t,primaryColorPressed:o,primaryColor:r,infoColor:i,successColor:a,warningColor:s,errorColor:l,baseColor:d,borderColor:u,tagColor:f,opacityDisabled:b,closeIconColor:C,closeIconColorHover:g,closeIconColorPressed:w,closeColorHover:y,closeColorPressed:v,borderRadiusSmall:k,fontSizeMini:_,fontSizeTiny:A,fontSizeSmall:$,fontSizeMedium:M,heightMini:x,heightTiny:T,heightSmall:I,heightMedium:O,buttonColor2Hover:V,buttonColor2Pressed:z,fontWeightStrong:Y}=e;return Object.assign(Object.assign({},commonVariables$j),{closeBorderRadius:k,heightTiny:x,heightSmall:T,heightMedium:I,heightLarge:O,borderRadius:k,opacityDisabled:b,fontSizeTiny:_,fontSizeSmall:A,fontSizeMedium:$,fontSizeLarge:M,fontWeightStrong:Y,textColorCheckable:n,textColorHoverCheckable:n,textColorPressedCheckable:n,textColorChecked:d,colorCheckable:"#0000",colorHoverCheckable:V,colorPressedCheckable:z,colorChecked:r,colorCheckedHover:t,colorCheckedPressed:o,border:`1px solid ${u}`,textColor:n,color:f,colorBordered:"#0000",closeIconColor:C,closeIconColorHover:g,closeIconColorPressed:w,closeColorHover:y,closeColorPressed:v,borderPrimary:`1px solid ${changeColor(r,{alpha:.3})}`,textColorPrimary:r,colorPrimary:changeColor(r,{alpha:.16}),colorBorderedPrimary:"#0000",closeIconColorPrimary:scaleColor(r,{lightness:.7}),closeIconColorHoverPrimary:scaleColor(r,{lightness:.7}),closeIconColorPressedPrimary:scaleColor(r,{lightness:.7}),closeColorHoverPrimary:changeColor(r,{alpha:.16}),closeColorPressedPrimary:changeColor(r,{alpha:.12}),borderInfo:`1px solid ${changeColor(i,{alpha:.3})}`,textColorInfo:i,colorInfo:changeColor(i,{alpha:.16}),colorBorderedInfo:"#0000",closeIconColorInfo:scaleColor(i,{alpha:.7}),closeIconColorHoverInfo:scaleColor(i,{alpha:.7}),closeIconColorPressedInfo:scaleColor(i,{alpha:.7}),closeColorHoverInfo:changeColor(i,{alpha:.16}),closeColorPressedInfo:changeColor(i,{alpha:.12}),borderSuccess:`1px solid ${changeColor(a,{alpha:.3})}`,textColorSuccess:a,colorSuccess:changeColor(a,{alpha:.16}),colorBorderedSuccess:"#0000",closeIconColorSuccess:scaleColor(a,{alpha:.7}),closeIconColorHoverSuccess:scaleColor(a,{alpha:.7}),closeIconColorPressedSuccess:scaleColor(a,{alpha:.7}),closeColorHoverSuccess:changeColor(a,{alpha:.16}),closeColorPressedSuccess:changeColor(a,{alpha:.12}),borderWarning:`1px solid ${changeColor(s,{alpha:.3})}`,textColorWarning:s,colorWarning:changeColor(s,{alpha:.16}),colorBorderedWarning:"#0000",closeIconColorWarning:scaleColor(s,{alpha:.7}),closeIconColorHoverWarning:scaleColor(s,{alpha:.7}),closeIconColorPressedWarning:scaleColor(s,{alpha:.7}),closeColorHoverWarning:changeColor(s,{alpha:.16}),closeColorPressedWarning:changeColor(s,{alpha:.11}),borderError:`1px solid ${changeColor(l,{alpha:.3})}`,textColorError:l,colorError:changeColor(l,{alpha:.16}),colorBorderedError:"#0000",closeIconColorError:scaleColor(l,{alpha:.7}),closeIconColorHoverError:scaleColor(l,{alpha:.7}),closeIconColorPressedError:scaleColor(l,{alpha:.7}),closeColorHoverError:changeColor(l,{alpha:.16}),closeColorPressedError:changeColor(l,{alpha:.12})})}},tagDark$1=tagDark,style$g=cB("base-clear",`
 flex-shrink: 0;
 height: 1em;
 width: 1em;
 position: relative;
...
`,[cE("input, textarea",`
 ...
 `)])]),inputProps=Object.assign(Object.assign({},useTheme.props),{bordered:{type:Boolean,default:void 0},type:{type:String,default:"text"},placeholder:[Array,String],defaultValue:{type:[String,Array],default:null},value:[String,Array],disabled:{type:Boolean,default:void 0},size:String,rows:{type:[Number,String],default:3},round:Boolean,minlength:[String,Number],maxlength:[String,Number],clearable:Boolean,autosize:{type:[Boolean,Object],default:!1},pair:Boolean,separator:String,readonly:{type:[String,Boolean],default:!1},passivelyActivated:Boolean,showPasswordOn:String,stateful:{type:Boolean,default:!0},autofocus:Boolean,inputProps:Object,resizable:{type:Boolean,default:!0},showCount:Boolean,loading:{type:Boolean,default:void 0},allowInput:Function,renderCount:Function,onMousedown:Function,onKeydown:Function,onKeyup:Function,onInput:[Function,Array],onFocus:[Function,Array],onBlur:[Function,Array],onClick:[Function,Array],onChange:[Function,Array],onClear:[Function,Array],countGraphemes:Function,status:String,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],textDecoration:[String,Array],attrSize:{type:Number,default:20},onInputBlur:[Function,Array],onInputFocus:[Function,Array],onDeactivate:[Function,Array],onActivate:[Function,Array],onWrapperFocus:[Function,Array],onWrapperBlur:[Function,Array],internalDeactivateOnEnter:Boolean,internalForceFocus:Boolean,internalLoadingBeforeSuffix:Boolean,showPasswordToggle:Boolean}),__unplugin_components_5=defineComponent({name:"Input",props:inputProps,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:t,inlineThemeDisabled:o,mergedRtlRef:r}=useConfig(e),i=useTheme("Input","-input",style$f,inputLight$1,e,n);isSafari&&useStyle("-input-safari",safariStyle,n);const a=ref(null),s=ref(null),l=ref(null),d=ref(null),u=ref(null),f=ref(null),b=ref(null),C=useCursor(b),g=ref(null),{localeRef:w}=useLocale("Input"),y=ref(e.defaultValue),v=toRef(e,"value"),k=useMergedState(v,y),_=useFormItem(e),{mergedSizeRef:A,mergedDisabledRef:$,mergedStatusRef:M}=_,x=ref(!1),T=ref(!1),I=ref(!1),O=ref(!1);let V=null;const z=computed(()=>{const{placeholder:D,pair:U}=e;return U?Array.isArray(D)?D:D===void 0?["",""]:[D,D]:D===void 0?[w.value.placeholder]:[D]}),Y=computed(()=>{const{value:D}=I,{value:U}=k,{value:ue}=z;return!D&&(isEmptyInputValue(U)||Array.isArray(U)&&isEmptyInputValue(U[0]))&&ue[0]}),L=computed(()=>{const{value:D}=I,{value:U}=k,{value:ue}=z;return!D&&ue[1]&&(isEmptyInputValue(U)||Array.isArray(U)&&isEmptyInputValue(U[1]))}),H=useMemo(()=>e.internalForceFocus||x.value),te=useMemo(()=>{if($.value||e.readonly||!e.clearable||!H.value&&!T.value)return!1;const{value:D}=k,{value:U}=H;return e.pair?!!(Array.isArray(D)&&(D[0]||D[1]))&&(T.value||U):!!D&&(T.value||U)}),j=computed(()=>{const{showPasswordOn:D}=e;if(D)return D;if(e.showPasswordToggle)return"click"}),ee=ref(!1),R=computed(()=>{const{textDecoration:D}=e;return D?Array.isArray(D)?D.map(U=>({textDecoration:U})):[{textDecoration:D}]:["",""]}),G=ref(void 0),pe=()=>{var D,U;if(e.type==="textarea"){const{autosize:ue}=e;if(ue&&(G.value=(U=(D=g.value)===null||D===void 0?void 0:D.$el)===null||U===void 0?void 0:U.offsetWidth),!s.value||typeof ue=="boolean")return;const{paddingTop:we,paddingBottom:De,lineHeight:Re}=window.getComputedStyle(s.value),Ye=Number(we.slice(0,-2)),Ze=Number(De.slice(0,-2)),Xe=Number(Re.slice(0,-2)),{value:nn}=l;if(!nn)return;if(ue.minRows){const tn=Math.max(ue.minRows,1),ln=`${Ye+Ze+Xe*tn}px`;nn.style.minHeight=ln}if(ue.maxRows){const tn=`${Ye+Ze+Xe*ue.maxRows}px`;nn.style.maxHeight=tn}}},me=computed(()=>{const{maxlength:D}=e;return D===void 0?void 0:Number(D)});onMounted(()=>{const{value:D}=k;Array.isArray(D)||He(D)});const Le=getCurrentInstance().proxy;function Ce(D){const{onUpdateValue:U,"onUpdate:value":ue,onInput:we}=e,{nTriggerFormInput:De}=_;U&&call(U,D),ue&&call(ue,D),we&&call(we,D),y.value=D,De()}function ye(D){const{onChange:U}=e,{nTriggerFormChange:ue}=_;U&&call(U,D),y.value=D,ue()}function de(D){const{onBlur:U}=e,{nTriggerFormBlur:ue}=_;U&&call(U,D),ue()}function ge(D){const{onFocus:U}=e,{nTriggerFormFocus:ue}=_;U&&call(U,D),ue()}function Ve(D){const{onClear:U}=e;U&&call(U,D)}function he(D){const{onInputBlur:U}=e;U&&call(U,D)}function Ke(D){const{onInputFocus:U}=e;U&&call(U,D)}function Pe(){const{onDeactivate:D}=e;D&&call(D)}function P(){const{onActivate:D}=e;D&&call(D)}function E(D){const{onClick:U}=e;U&&call(U,D)}function F(D){const{onWrapperFocus:U}=e;U&&call(U,D)}function K(D){const{onWrapperBlur:U}=e;U&&call(U,D)}function q(){I.value=!0}function ne(D){I.value=!1,D.target===f.value?oe(D,1):oe(D,0)}function oe(D,U=0,ue="input"){const we=D.target.value;if(He(we),D instanceof InputEvent&&!D.isComposing&&(I.value=!1),e.type==="textarea"){const{value:Re}=g;Re&&Re.syncUnifiedContainer()}if(V=we,I.value)return;C.recordCursor();const De=Q(we);if(De)if(!e.pair)ue==="input"?Ce(we):ye(we);else{let{value:Re}=k;Array.isArray(Re)?Re=[Re[0],Re[1]]:Re=["",""],Re[U]=we,ue==="input"?Ce(Re):ye(Re)}Le.$forceUpdate(),De||nextTick(C.restoreCursor)}function Q(D){const{countGraphemes:U,maxlength:ue,minlength:we}=e;if(U){let Re;if(ue!==void 0&&(Re===void 0&&(Re=U(D)),Re>Number(ue))||we!==void 0&&(Re===void 0&&(Re=U(D)),Re<Number(ue)))return!1}const{allowInput:De}=e;return typeof De=="function"?De(D):!0}function Z(D){he(D),D.relatedTarget===a.value&&Pe(),D.relatedTarget!==null&&(D.relatedTarget===u.value||D.relatedTarget===f.value||D.relatedTarget===s.value)||(O.value=!1),X(D,"blur"),b.value=null}function W(D,U){Ke(D),x.value=!0,O.value=!0,P(),X(D,"focus"),U===0?b.value=u.value:U===1?b.value=f.value:U===2&&(b.value=s.value)}function ce(D){e.passivelyActivated&&(K(D),X(D,"blur"))}function se(D){e.passivelyActivated&&(x.value=!0,F(D),X(D,"focus"))}function X(D,U){D.relatedTarget!==null&&(D.relatedTarget===u.value||D.relatedTarget===f.value||D.relatedTarget===s.value||D.relatedTarget===a.value)||(U==="focus"?(ge(D),x.value=!0):U==="blur"&&(de(D),x.value=!1))}function ie(D,U){oe(D,U,"change")}function le(D){E(D)}function Se(D){Ve(D),e.pair?(Ce(["",""]),ye(["",""])):(Ce(""),ye(""))}function be(D){const{onMousedown:U}=e;U&&U(D);const{tagName:ue}=D.target;if(ue!=="INPUT"&&ue!=="TEXTAREA"){if(e.resizable){const{value:we}=a;if(we){const{left:De,top:Re,width:Ye,height:Ze}=we.getBoundingClientRect(),Xe=14;if(De+Ye-Xe<D.clientX&&D.clientX<De+Ye&&Re+Ze-Xe<D.clientY&&D.clientY<Re+Ze)return}}D.preventDefault(),x.value||J()}}function Te(){var D;T.value=!0,e.type==="textarea"&&((D=g.value)===null||D===void 0||D.handleMouseEnterWrapper())}function Ee(){var D;T.value=!1,e.type==="textarea"&&((D=g.value)===null||D===void 0||D.handleMouseLeaveWrapper())}function Ge(){$.value||j.value==="click"&&(ee.value=!ee.value)}function Qe(D){if($.value)return;D.preventDefault();const U=we=>{we.preventDefault(),off("mouseup",document,U)};if(on("mouseup",document,U),j.value!=="mousedown")return;ee.value=!0;const ue=()=>{ee.value=!1,off("mouseup",document,ue)};on("mouseup",document,ue)}function Je(D){var U;switch((U=e.onKeydown)===null||U===void 0||U.call(e,D),D.key){case"Escape":Be();break;case"Enter":qe(D);break}}function qe(D){var U,ue;if(e.passivelyActivated){const{value:we}=O;if(we){e.internalDeactivateOnEnter&&Be();return}D.preventDefault(),e.type==="textarea"?(U=s.value)===null||U===void 0||U.focus():(ue=u.value)===null||ue===void 0||ue.focus()}}function Be(){e.passivelyActivated&&(O.value=!1,nextTick(()=>{var D;(D=a.value)===null||D===void 0||D.focus()}))}function J(){var D,U,ue;$.value||(e.passivelyActivated?(D=a.value)===null||D===void 0||D.focus():((U=s.value)===null||U===void 0||U.focus(),(ue=u.value)===null||ue===void 0||ue.focus()))}function ae(){var D;!((D=a.value)===null||D===void 0)&&D.contains(document.activeElement)&&document.activeElement.blur()}function fe(){var D,U;(D=s.value)===null||D===void 0||D.select(),(U=u.value)===null||U===void 0||U.select()}function ve(){$.value||(s.value?s.value.focus():u.value&&u.value.focus())}function ke(){const{value:D}=a;D!=null&&D.contains(document.activeElement)&&D!==document.activeElement&&Be()}function ze(D){if(e.type==="textarea"){const{value:U}=s;U==null||U.scrollTo(D)}else{const{value:U}=u;U==null||U.scrollTo(D)}}function He(D){const{type:U,pair:ue,autosize:we}=e;if(!ue&&we)if(U==="textarea"){const{value:De}=l;De&&(De.textContent=(D??"")+`\r
`)}else{const{value:De}=d;De&&(D?De.textContent=D:De.innerHTML="&nbsp;")}}function Ae(){pe()}const je=ref({top:"0"});function Ie(D){var U;const{scrollTop:ue}=D.target;je.value.top=`${-ue}px`,(U=g.value)===null||U===void 0||U.syncUnifiedContainer()}let Me=null;watchEffect(()=>{const{autosize:D,type:U}=e;D&&U==="textarea"?Me=watch(k,ue=>{!Array.isArray(ue)&&ue!==V&&He(ue)}):Me==null||Me()});let Ue=null;watchEffect(()=>{e.type==="textarea"?Ue=watch(k,D=>{var U;!Array.isArray(D)&&D!==V&&((U=g.value)===null||U===void 0||U.syncUnifiedContainer())}):Ue==null||Ue()}),provide(inputInjectionKey,{mergedValueRef:k,maxlengthRef:me,mergedClsPrefixRef:n,countGraphemesRef:toRef(e,"countGraphemes")});const rn={wrapperElRef:a,inputElRef:u,textareaElRef:s,isCompositing:I,focus:J,blur:ae,select:fe,deactivate:ke,activate:ve,scrollTo:ze},en=useRtl("Input",r,n),Fe=computed(()=>{const{value:D}=A,{common:{cubicBezierEaseInOut:U},self:{color:ue,borderRadius:we,textColor:De,caretColor:Re,caretColorError:Ye,caretColorWarning:Ze,textDecorationColor:Xe,border:nn,borderDisabled:tn,borderHover:ln,borderFocus:vn,placeholderColor:yn,placeholderColorDisabled:Cn,lineHeightTextarea:xn,colorDisabled:Ne,colorFocus:cn,textColorDisabled:wn,boxShadowFocus:pn,iconSize:an,colorFocusWarning:_e,boxShadowFocusWarning:Sn,borderWarning:dn,borderFocusWarning:hn,borderHoverWarning:Tn,colorFocusError:un,boxShadowFocusError:fn,borderError:mn,borderFocusError:kn,borderHoverError:gn,clearSize:bn,clearColor:m,clearColorHover:S,clearColorPressed:B,iconColor:N,iconColorDisabled:re,suffixTextColor:xe,countTextColor:$e,countTextColorDisabled:Oe,iconColorHover:sn,iconColorPressed:Pn,loadingColor:An,loadingColorError:Rn,loadingColorWarning:En,[createKey("padding",D)]:Dn,[createKey("fontSize",D)]:Mn,[createKey("height",D)]:In}}=i.value,{left:_n,right:On}=getMargin(Dn);return{"--n-bezier":U,"--n-count-text-color":$e,"--n-count-text-color-disabled":Oe,"--n-color":ue,"--n-font-size":Mn,"--n-border-radius":we,"--n-height":In,"--n-padding-left":_n,"--n-padding-right":On,"--n-text-color":De,"--n-caret-color":Re,"--n-text-decoration-color":Xe,"--n-border":nn,"--n-border-disabled":tn,"--n-border-hover":ln,"--n-border-focus":vn,"--n-placeholder-color":yn,"--n-placeholder-color-disabled":Cn,"--n-icon-size":an,"--n-line-height-textarea":xn,"--n-color-disabled":Ne,"--n-color-focus":cn,"--n-text-color-disabled":wn,"--n-box-shadow-focus":pn,"--n-loading-color":An,"--n-caret-color-warning":Ze,"--n-color-focus-warning":_e,"--n-box-shadow-focus-warning":Sn,"--n-border-warning":dn,"--n-border-focus-warning":hn,"--n-border-hover-warning":Tn,"--n-loading-color-warning":En,"--n-caret-color-error":Ye,"--n-color-focus-error":un,"--n-box-shadow-focus-error":fn,"--n-border-error":mn,"--n-border-focus-error":kn,"--n-border-hover-error":gn,"--n-loading-color-error":Rn,"--n-clear-color":m,"--n-clear-size":bn,"--n-clear-color-hover":S,"--n-clear-color-pressed":B,"--n-icon-color":N,"--n-icon-color-hover":sn,"--n-icon-color-pressed":Pn,"--n-icon-color-disabled":re,"--n-suffix-text-color":xe}}),We=o?useThemeClass("input",computed(()=>{const{value:D}=A;return D[0]}),Fe,e):void 0;return Object.assign(Object.assign({},rn),{wrapperElRef:a,inputElRef:u,inputMirrorElRef:d,inputEl2Ref:f,textareaElRef:s,textareaMirrorElRef:l,textareaScrollbarInstRef:g,rtlEnabled:en,uncontrolledValue:y,mergedValue:k,passwordVisible:ee,mergedPlaceholder:z,showPlaceholder1:Y,showPlaceholder2:L,mergedFocus:H,isComposing:I,activated:O,showClearButton:te,mergedSize:A,mergedDisabled:$,textDecorationStyle:R,mergedClsPrefix:n,mergedBordered:t,mergedShowPasswordOn:j,placeholderStyle:je,mergedStatus:M,textAreaScrollContainerWidth:G,handleTextAreaScroll:Ie,handleCompositionStart:q,handleCompositionEnd:ne,handleInput:oe,handleInputBlur:Z,handleInputFocus:W,handleWrapperBlur:ce,handleWrapperFocus:se,handleMouseEnter:Te,handleMouseLeave:Ee,handleMouseDown:be,handleChange:ie,handleClick:le,handleClear:Se,handlePasswordToggleClick:Ge,handlePasswordToggleMousedown:Qe,handleWrapperKeydown:Je,handleTextAreaMirrorResize:Ae,getTextareaScrollContainer:()=>s.value,mergedTheme:i,cssVars:o?void 0:Fe,themeClass:We==null?void 0:We.themeClass,onRender:We==null?void 0:We.onRender})},render(){var e,n;const{mergedClsPrefix:t,mergedStatus:o,themeClass:r,type:i,countGraphemes:a,onRender:s}=this,l=this.$slots;return s==null||s(),h("div",{ref:"wrapperElRef",class:[`${t}-input`,r,o&&`${t}-input--${o}-status`,{[`${t}-input--rtl`]:this.rtlEnabled,[`${t}-input--disabled`]:this.mergedDisabled,[`${t}-input--textarea`]:i==="textarea",[`${t}-input--resizable`]:this.resizable&&!this.autosize,[`${t}-input--autosize`]:this.autosize,[`${t}-input--round`]:this.round&&i!=="textarea",[`${t}-input--pair`]:this.pair,[`${t}-input--focus`]:this.mergedFocus,[`${t}-input--stateful`]:this.stateful}],style:this.cssVars,tabindex:!this.mergedDisabled&&this.passivelyActivated&&!this.activated?0:void 0,onFocus:this.handleWrapperFocus,onBlur:this.handleWrapperBlur,onClick:this.handleClick,onMousedown:this.handleMouseDown,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd,onKeyup:this.onKeyup,onKeydown:this.handleWrapperKeydown},h("div",{class:`${t}-input-wrapper`},resolveWrappedSlot(l.prefix,d=>d&&h("div",{class:`${t}-input__prefix`},d)),i==="textarea"?h(NScrollbar,{ref:"textareaScrollbarInstRef",class:`${t}-input__textarea`,container:this.getTextareaScrollContainer,triggerDisplayManually:!0,useUnifiedContainer:!0,internalHoistYRail:!0},{default:()=>{var d,u;const{textAreaScrollContainerWidth:f}=this,b={width:this.autosize&&f&&`${f}px`};return h(Fragment,null,h("textarea",Object.assign({},this.inputProps,{ref:"textareaElRef",class:[`${t}-input__textarea-el`,(d=this.inputProps)===null||d===void 0?void 0:d.class],autofocus:this.autofocus,rows:Number(this.rows),placeholder:this.placeholder,value:this.mergedValue,disabled:this.mergedDisabled,maxlength:a?void 0:this.maxlength,minlength:a?void 0:this.minlength,readonly:this.readonly,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,style:[this.textDecorationStyle[0],(u=this.inputProps)===null||u===void 0?void 0:u.style,b],onBlur:this.handleInputBlur,onFocus:C=>this.handleInputFocus(C,2),onInput:this.handleInput,onChange:this.handleChange,onScroll:this.handleTextAreaScroll})),this.showPlaceholder1?h("div",{class:`${t}-input__placeholder`,style:[this.placeholderStyle,b],key:"placeholder"},this.mergedPlaceholder[0]):null,this.autosize?h(VResizeObserver,{onResize:this.handleTextAreaMirrorResize},{default:()=>h("div",{ref:"textareaMirrorElRef",class:`${t}-input__textarea-mirror`,key:"mirror"})}):null)}}):h("div",{class:`${t}-input__input`},h("input",Object.assign({type:i==="password"&&this.mergedShowPasswordOn&&this.passwordVisible?"text":i},this.inputProps,{ref:"inputElRef",class:[`${t}-input__input-el`,(e=this.inputProps)===null||e===void 0?void 0:e.class],style:[this.textDecorationStyle[0],(n=this.inputProps)===null||n===void 0?void 0:n.style],tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[0],disabled:this.mergedDisabled,maxlength:a?void 0:this.maxlength,minlength:a?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[0]:this.mergedValue,readonly:this.readonly,autofocus:this.autofocus,size:this.attrSize,onBlur:this.handleInputBlur,onFocus:d=>this.handleInputFocus(d,0),onInput:d=>this.handleInput(d,0),onChange:d=>this.handleChange(d,0)})),this.showPlaceholder1?h("div",{class:`${t}-input__placeholder`},h("span",null,this.mergedPlaceholder[0])):null,this.autosize?h("div",{class:`${t}-input__input-mirror`,key:"mirror",ref:"inputMirrorElRef"}," "):null),!this.pair&&resolveWrappedSlot(l.suffix,d=>d||this.clearable||this.showCount||this.mergedShowPasswordOn||this.loading!==void 0?h("div",{class:`${t}-input__suffix`},[resolveWrappedSlot(l["clear-icon-placeholder"],u=>(this.clearable||u)&&h(NBaseClear,{clsPrefix:t,show:this.showClearButton,onClear:this.handleClear},{placeholder:()=>u,icon:()=>{var f,b;return(b=(f=this.$slots)["clear-icon"])===null||b===void 0?void 0:b.call(f)}})),this.internalLoadingBeforeSuffix?null:d,this.loading!==void 0?h(NBaseSuffix,{clsPrefix:t,loading:this.loading,showArrow:!1,showClear:!1,style:this.cssVars}):null,this.internalLoadingBeforeSuffix?d:null,this.showCount&&this.type!=="textarea"?h(WordCount,null,{default:u=>{var f;return(f=l.count)===null||f===void 0?void 0:f.call(l,u)}}):null,this.mergedShowPasswordOn&&this.type==="password"?h("div",{class:`${t}-input__eye`,onMousedown:this.handlePasswordToggleMousedown,onClick:this.handlePasswordToggleClick},this.passwordVisible?resolveSlot(l["password-visible-icon"],()=>[h(NBaseIcon,{clsPrefix:t},{default:()=>h(EyeIcon,null)})]):resolveSlot(l["password-invisible-icon"],()=>[h(NBaseIcon,{clsPrefix:t},{default:()=>h(EyeOffIcon,null)})])):null]):null)),this.pair?h("span",{class:`${t}-input__separator`},resolveSlot(l.separator,()=>[this.separator])):null,this.pair?h("div",{class:`${t}-input-wrapper`},h("div",{class:`${t}-input__input`},h("input",{ref:"inputEl2Ref",type:this.type,class:`${t}-input__input-el`,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[1],disabled:this.mergedDisabled,maxlength:a?void 0:this.maxlength,minlength:a?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[1]:void 0,readonly:this.readonly,style:this.textDecorationStyle[1],onBlur:this.handleInputBlur,onFocus:d=>this.handleInputFocus(d,1),onInput:d=>this.handleInput(d,1),onChange:d=>this.handleChange(d,1)}),this.showPlaceholder2?h("div",{class:`${t}-input__placeholder`},h("span",null,this.mergedPlaceholder[1])):null),resolveWrappedSlot(l.suffix,d=>(this.clearable||d)&&h("div",{class:`${t}-input__suffix`},[this.clearable&&h(NBaseClear,{clsPrefix:t,show:this.showClearButton,onClear:this.handleClear},{icon:()=>{var u;return(u=l["clear-icon"])===null||u===void 0?void 0:u.call(l)},placeholder:()=>{var u;return(u=l["clear-icon-placeholder"])===null||u===void 0?void 0:u.call(l)}}),d]))):null,this.mergedBordered?h("div",{class:`${t}-input__border`}):null,this.mergedBordered?h("div",{class:`${t}-input__state-border`}):null,this.showCount&&i==="textarea"?h(WordCount,null,{default:d=>{var u;const{renderCount:f}=this;return f?f(d):(u=l.count)===null||u===void 0?void 0:u.call(l,d)}}):null)}});function self$N(e){const{boxShadow2:n}=e;return{menuBoxShadow:n}}const autoCompleteDark={name:"AutoComplete",common:commonDark,peers:{InternalSelectMenu:internalSelectMenuDark$1,Input:inputDark$1},self:self$N},autoCompleteDark$1=autoCompleteDark,self$M=e=>{const{borderRadius:n,avatarColor:t,cardColor:o,fontSize:r,heightTiny:i,heightSmall:a,heightMedium:s,heightLarge:l,heightHuge:d,modalColor:u,popoverColor:f}=e;return{borderRadius:n,fontSize:r,border:`2px solid ${o}`,heightTiny:i,heightSmall:a,heightMedium:s,heightLarge:l,heightHuge:d,color:composite(o,t),colorModal:composite(u,t),colorPopover:composite(f,t)}},avatarDark={name:"Avatar",common:commonDark,self:self$M},avatarDark$1=avatarDark,self$L=()=>({gap:"-12px"}),avatarGroupDark={name:"AvatarGroup",common:commonDark,peers:{Avatar:avatarDark$1},self:self$L},avatarGroupDark$1=avatarGroupDark,commonVariables$h={width:"44px",height:"44px",borderRadius:"22px",iconSize:"26px"},backTopDark={name:"BackTop",common:commonDark,self(e){const{popoverColor:n,textColor2:t,primaryColorHover:o,primaryColorPressed:r}=e;return Object.assign(Object.assign({},commonVariables$h),{color:n,textColor:t,iconColor:t,iconColorHover:o,iconColorPressed:r,boxShadow:"0 2px 8px 0px rgba(0, 0, 0, .12)",boxShadowHover:"0 2px 12px 0px rgba(0, 0, 0, .18)",boxShadowPressed:"0 2px 12px 0px rgba(0, 0, 0, .18)"})}},backTopDark$1=backTopDark,badgeDark={name:"Badge",common:commonDark,self(e){const{errorColorSuppl:n,infoColorSuppl:t,successColorSuppl:o,warningColorSuppl:r,fontFamily:i}=e;return{color:n,colorInfo:t,colorSuccess:o,colorError:n,colorWarning:r,fontSize:"12px",fontFamily:i}}},badgeDark$1=badgeDark,commonVariables$g={fontWeightActive:"400"},self$K=e=>{const{fontSize:n,textColor3:t,textColor2:o,borderRadius:r,buttonColor2Hover:i,buttonColor2Pressed:a}=e;return Object.assign(Object.assign({},commonVariables$g),{fontSize:n,itemLineHeight:"1.25",itemTextColor:t,itemTextColorHover:o,itemTextColorPressed:o,itemTextColorActive:o,itemBorderRadius:r,itemColorHover:i,itemColorPressed:a,separatorColor:t})},breadcrumbDark={name:"Breadcrumb",common:commonDark,self:self$K},breadcrumbDark$1=breadcrumbDark;function createHoverColor(e){return composite(e,[255,255,255,.16])}function createPressedColor(e){return composite(e,[0,0,0,.12])}const buttonGroupInjectionKey="n-button-group",commonVariables$f={paddingTiny:"0 6px",paddingSmall:"0 10px",paddingMedium:"0 14px",paddingLarge:"0 18px",paddingRoundTiny:"0 10px",paddingRoundSmall:"0 14px",paddingRoundMedium:"0 18px",paddingRoundLarge:"0 22px",iconMarginTiny:"6px",iconMarginSmall:"6px",iconMarginMedium:"6px",iconMarginLarge:"6px",iconSizeTiny:"14px",iconSizeSmall:"18px",iconSizeMedium:"18px",iconSizeLarge:"20px",rippleDuration:".6s"},self$J=e=>{const{heightTiny:n,heightSmall:t,heightMedium:o,heightLarge:r,borderRadius:i,fontSizeTiny:a,fontSizeSmall:s,fontSizeMedium:l,fontSizeLarge:d,opacityDisabled:u,textColor2:f,textColor3:b,primaryColorHover:C,primaryColorPressed:g,borderColor:w,primaryColor:y,baseColor:v,infoColor:k,infoColorHover:_,infoColorPressed:A,successColor:$,successColorHover:M,successColorPressed:x,warningColor:T,warningColorHover:I,warningColorPressed:O,errorColor:V,errorColorHover:z,errorColorPressed:Y,fontWeight:L,buttonColor2:H,buttonColor2Hover:te,buttonColor2Pressed:j,fontWeightStrong:ee}=e;return Object.assign(Object.assign({},commonVariables$f),{heightTiny:n,heightSmall:t,heightMedium:o,heightLarge:r,borderRadiusTiny:i,borderRadiusSmall:i,borderRadiusMedium:i,borderRadiusLarge:i,fontSizeTiny:a,fontSizeSmall:s,fontSizeMedium:l,fontSizeLarge:d,opacityDisabled:u,colorOpacitySecondary:"0.16",colorOpacitySecondaryHover:"0.22",colorOpacitySecondaryPressed:"0.28",colorSecondary:H,colorSecondaryHover:te,colorSecondaryPressed:j,colorTertiary:H,colorTertiaryHover:te,colorTertiaryPressed:j,colorQuaternary:"#0000",colorQuaternaryHover:te,colorQuaternaryPressed:j,color:"#0000",colorHover:"#0000",colorPressed:"#0000",colorFocus:"#0000",colorDisabled:"#0000",textColor:f,textColorTertiary:b,textColorHover:C,textColorPressed:g,textColorFocus:C,textColorDisabled:f,textColorText:f,textColorTextHover:C,textColorTextPressed:g,textColorTextFocus:C,textColorTextDisabled:f,textColorGhost:f,textColorGhostHover:C,textColorGhostPressed:g,textColorGhostFocus:C,textColorGhostDisabled:f,border:`1px solid ${w}`,borderHover:`1px solid ${C}`,borderPressed:`1px solid ${g}`,borderFocus:`1px solid ${C}`,borderDisabled:`1px solid ${w}`,rippleColor:y,colorPrimary:y,colorHoverPrimary:C,colorPressedPrimary:g,colorFocusPrimary:C,colorDisabledPrimary:y,textColorPrimary:v,textColorHoverPrimary:v,textColorPressedPrimary:v,textColorFocusPrimary:v,textColorDisabledPrimary:v,textColorTextPrimary:y,textColorTextHoverPrimary:C,textColorTextPressedPrimary:g,textColorTextFocusPrimary:C,textColorTextDisabledPrimary:f,textColorGhostPrimary:y,textColorGhostHoverPrimary:C,textColorGhostPressedPrimary:g,textColorGhostFocusPrimary:C,textColorGhostDisabledPrimary:y,borderPrimary:`1px solid ${y}`,borderHoverPrimary:`1px solid ${C}`,borderPressedPrimary:`1px solid ${g}`,borderFocusPrimary:`1px solid ${C}`,borderDisabledPrimary:`1px solid ${y}`,rippleColorPrimary:y,colorInfo:k,colorHoverInfo:_,colorPressedInfo:A,colorFocusInfo:_,colorDisabledInfo:k,textColorInfo:v,textColorHoverInfo:v,textColorPressedInfo:v,textColorFocusInfo:v,textColorDisabledInfo:v,textColorTextInfo:k,textColorTextHoverInfo:_,textColorTextPressedInfo:A,textColorTextFocusInfo:_,textColorTextDisabledInfo:f,textColorGhostInfo:k,textColorGhostHoverInfo:_,textColorGhostPressedInfo:A,textColorGhostFocusInfo:_,textColorGhostDisabledInfo:k,borderInfo:`1px solid ${k}`,borderHoverInfo:`1px solid ${_}`,borderPressedInfo:`1px solid ${A}`,borderFocusInfo:`1px solid ${_}`,borderDisabledInfo:`1px solid ${k}`,rippleColorInfo:k,colorSuccess:$,colorHoverSuccess:M,colorPressedSuccess:x,colorFocusSuccess:M,colorDisabledSuccess:$,textColorSuccess:v,textColorHoverSuccess:v,textColorPressedSuccess:v,textColorFocusSuccess:v,textColorDisabledSuccess:v,textColorTextSuccess:$,textColorTextHoverSuccess:M,textColorTextPressedSuccess:x,textColorTextFocusSuccess:M,textColorTextDisabledSuccess:f,textColorGhostSuccess:$,textColorGhostHoverSuccess:M,textColorGhostPressedSuccess:x,textColorGhostFocusSuccess:M,textColorGhostDisabledSuccess:$,borderSuccess:`1px solid ${$}`,borderHoverSuccess:`1px solid ${M}`,borderPressedSuccess:`1px solid ${x}`,borderFocusSuccess:`1px solid ${M}`,borderDisabledSuccess:`1px solid ${$}`,rippleColorSuccess:$,colorWarning:T,colorHoverWarning:I,colorPressedWarning:O,colorFocusWarning:I,colorDisabledWarning:T,textColorWarning:v,textColorHoverWarning:v,textColorPressedWarning:v,textColorFocusWarning:v,textColorDisabledWarning:v,textColorTextWarning:T,textColorTextHoverWarning:I,textColorTextPressedWarning:O,textColorTextFocusWarning:I,textColorTextDisabledWarning:f,textColorGhostWarning:T,textColorGhostHoverWarning:I,textColorGhostPressedWarning:O,textColorGhostFocusWarning:I,textColorGhostDisabledWarning:T,borderWarning:`1px solid ${T}`,borderHoverWarning:`1px solid ${I}`,borderPressedWarning:`1px solid ${O}`,borderFocusWarning:`1px solid ${I}`,borderDisabledWarning:`1px solid ${T}`,rippleColorWarning:T,colorError:V,colorHoverError:z,colorPressedError:Y,colorFocusError:z,colorDisabledError:V,textColorError:v,textColorHoverError:v,textColorPressedError:v,textColorFocusError:v,textColorDisabledError:v,textColorTextError:V,textColorTextHoverError:z,textColorTextPressedError:Y,textColorTextFocusError:z,textColorTextDisabledError:f,textColorGhostError:V,textColorGhostHoverError:z,textColorGhostPressedError:Y,textColorGhostFocusError:z,textColorGhostDisabledError:V,borderError:`1px solid ${V}`,borderHoverError:`1px solid ${z}`,borderPressedError:`1px solid ${Y}`,borderFocusError:`1px solid ${z}`,borderDisabledError:`1px solid ${V}`,rippleColorError:V,waveOpacity:"0.6",fontWeight:L,fontWeightStrong:ee})},buttonLight={name:"Button",common:commonLight,self:self$J},buttonDark={name:"Button",common:commonDark,self(e){const n=self$J(e);return n.waveOpacity="0.8",n.colorOpacitySecondary="0.16",n.colorOpacitySecondaryHover="0.2",n.colorOpacitySecondaryPressed="0.12",n}},buttonDark$1=buttonDark,style$e=c$1([cB("button",`
 margin: 0;
 ...
 display: flex;
 width: 100%;
 `),cM("dashed",[cE("border, state-border",{borderStyle:"dashed !important"})]),cM("disabled",{cursor:"not-allowed",opacity:"var(--n-opacity-disabled)"})]),c$1("@keyframes button-wave-spread",{from:{boxShadow:"0 0 0.5px 0 var(--n-ripple-color)"},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)"}}),c$1("@keyframes button-wave-opacity",{from:{opacity:"var(--n-wave-opacity)"},to:{opacity:0}})]),buttonProps=Object.assign(Object.assign({},useTheme.props),{color:String,textColor:String,text:Boolean,block:Boolean,loading:Boolean,disabled:Boolean,circle:Boolean,size:String,ghost:Boolean,round:Boolean,secondary:Boolean,tertiary:Boolean,quaternary:Boolean,strong:Boolean,focusable:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},tag:{type:String,default:"button"},type:{type:String,default:"default"},dashed:Boolean,renderIcon:Function,iconPlacement:{type:String,default:"left"},attrType:{type:String,default:"button"},bordered:{type:Boolean,default:!0},onClick:[Function,Array],nativeFocusBehavior:{type:Boolean,default:!isSafari}}),Button=defineComponent({name:"Button",props:buttonProps,setup(e){const n=ref(null),t=ref(null),o=ref(!1),r=useMemo(()=>!e.quaternary&&!e.tertiary&&!e.secondary&&!e.text&&(!e.color||e.ghost||e.dashed)&&e.bordered),i=inject(buttonGroupInjectionKey,{}),{mergedSizeRef:a}=useFormItem({},{defaultSize:"medium",mergedSize:A=>{const{size:$}=e;if($)return $;const{size:M}=i;if(M)return M;const{mergedSize:x}=A||{};return x?x.value:"medium"}}),s=computed(()=>e.focusable&&!e.disabled),l=A=>{var $;s.value||A.preventDefault(),!e.nativeFocusBehavior&&(A.preventDefault(),!e.disabled&&s.value&&(($=n.value)===null||$===void 0||$.focus({preventScroll:!0})))},d=A=>{var $;if(!e.disabled&&!e.loading){const{onClick:M}=e;M&&call(M,A),e.text||($=t.value)===null||$===void 0||$.play()}},u=A=>{switch(A.key){case"Enter":if(!e.keyboard)return;o.value=!1}},f=A=>{switch(A.key){case"Enter":if(!e.keyboard||e.loading){A.preventDefault();return}o.value=!0}},b=()=>{o.value=!1},{inlineThemeDisabled:C,mergedClsPrefixRef:g,mergedRtlRef:w}=useConfig(e),y=useTheme("Button","-button",style$e,buttonLight,e,g),v=useRtl("Button",w,g),k=computed(()=>{const A=y.value,{common:{cubicBezierEaseInOut:$,cubicBezierEaseOut:M},self:x}=A,{rippleDuration:T,opacityDisabled:I,fontWeight:O,fontWeightStrong:V}=x,z=a.value,{dashed:Y,type:L,ghost:H,text:te,color:j,round:ee,circle:R,textColor:G,secondary:pe,tertiary:me,quaternary:Le,strong:Ce}=e,ye={"font-weight":Ce?V:O};let de={"--n-color":"initial","--n-color-hover":"initial","--n-color-pressed":"initial","--n-color-focus":"initial","--n-color-disabled":"initial","--n-ripple-color":"initial","--n-text-color":"initial","--n-text-color-hover":"initial","--n-text-color-pressed":"initial","--n-text-color-focus":"initial","--n-text-color-disabled":"initial"};const ge=L==="tertiary",Ve=L==="default",he=ge?"default":L;if(te){const Z=G||j;de={"--n-color":"#0000","--n-color-hover":"#0000","--n-color-pressed":"#0000","--n-color-focus":"#0000","--n-color-disabled":"#0000","--n-ripple-color":"#0000","--n-text-color":Z||x[createKey("textColorText",he)],"--n-text-color-hover":Z?createHoverColor(Z):x[createKey("textColorTextHover",he)],"--n-text-color-pressed":Z?createPressedColor(Z):x[createKey("textColorTextPressed",he)],"--n-text-color-focus":Z?createHoverColor(Z):x[createKey("textColorTextHover",he)],"--n-text-color-disabled":Z||x[createKey("textColorTextDisabled",he)]}}else if(H||Y){const Z=G||j;de={"--n-color":"#0000","--n-color-hover":"#0000","--n-color-pressed":"#0000","--n-color-focus":"#0000","--n-color-disabled":"#0000","--n-ripple-color":j||x[createKey("rippleColor",he)],"--n-text-color":Z||x[createKey("textColorGhost",he)],"--n-text-color-hover":Z?createHoverColor(Z):x[createKey("textColorGhostHover",he)],"--n-text-color-pressed":Z?createPressedColor(Z):x[createKey("textColorGhostPressed",he)],"--n-text-color-focus":Z?createHoverColor(Z):x[createKey("textColorGhostHover",he)],"--n-text-color-disabled":Z||x[createKey("textColorGhostDisabled",he)]}}else if(pe){const Z=Ve?x.textColor:ge?x.textColorTertiary:x[createKey("color",he)],W=j||Z,ce=L!=="default"&&L!=="tertiary";de={"--n-color":ce?changeColor(W,{alpha:Number(x.colorOpacitySecondary)}):x.colorSecondary,"--n-color-hover":ce?changeColor(W,{alpha:Number(x.colorOpacitySecondaryHover)}):x.colorSecondaryHover,"--n-color-pressed":ce?changeColor(W,{alpha:Number(x.colorOpacitySecondaryPressed)}):x.colorSecondaryPressed,"--n-color-focus":ce?changeColor(W,{alpha:Number(x.colorOpacitySecondaryHover)}):x.colorSecondaryHover,"--n-color-disabled":x.colorSecondary,"--n-ripple-color":"#0000","--n-text-color":W,"--n-text-color-hover":W,"--n-text-color-pressed":W,"--n-text-color-focus":W,"--n-text-color-disabled":W}}else if(me||Le){const Z=Ve?x.textColor:ge?x.textColorTertiary:x[createKey("color",he)],W=j||Z;me?(de["--n-color"]=x.colorTertiary,de["--n-color-hover"]=x.colorTertiaryHover,de["--n-color-pressed"]=x.colorTertiaryPressed,de["--n-color-focus"]=x.colorSecondaryHover,de["--n-color-disabled"]=x.colorTertiary):(de["--n-color"]=x.colorQuaternary,de["--n-color-hover"]=x.colorQuaternaryHover,de["--n-color-pressed"]=x.colorQuaternaryPressed,de["--n-color-focus"]=x.colorQuaternaryHover,de["--n-color-disabled"]=x.colorQuaternary),de["--n-ripple-color"]="#0000",de["--n-text-color"]=W,de["--n-text-color-hover"]=W,de["--n-text-color-pressed"]=W,de["--n-text-color-focus"]=W,de["--n-text-color-disabled"]=W}else de={"--n-color":j||x[createKey("color",he)],"--n-color-hover":j?createHoverColor(j):x[createKey("colorHover",he)],"--n-color-pressed":j?createPressedColor(j):x[createKey("colorPressed",he)],"--n-color-focus":j?createHoverColor(j):x[createKey("colorFocus",he)],"--n-color-disabled":j||x[createKey("colorDisabled",he)],"--n-ripple-color":j||x[createKey("rippleColor",he)],"--n-text-color":G||(j?x.textColorPrimary:ge?x.textColorTertiary:x[createKey("textColor",he)]),"--n-text-color-hover":G||(j?x.textColorHoverPrimary:x[createKey("textColorHover",he)]),"--n-text-color-pressed":G||(j?x.textColorPressedPrimary:x[createKey("textColorPressed",he)]),"--n-text-color-focus":G||(j?x.textColorFocusPrimary:x[createKey("textColorFocus",he)]),"--n-text-color-disabled":G||(j?x.textColorDisabledPrimary:x[createKey("textColorDisabled",he)])};let Ke={"--n-border":"initial","--n-border-hover":"initial","--n-border-pressed":"initial","--n-border-focus":"initial","--n-border-disabled":"initial"};te?Ke={"--n-border":"none","--n-border-hover":"none","--n-border-pressed":"none","--n-border-focus":"none","--n-border-disabled":"none"}:Ke={"--n-border":x[createKey("border",he)],"--n-border-hover":x[createKey("borderHover",he)],"--n-border-pressed":x[createKey("borderPressed",he)],"--n-border-focus":x[createKey("borderFocus",he)],"--n-border-disabled":x[createKey("borderDisabled",he)]};const{[createKey("height",z)]:Pe,[createKey("fontSize",z)]:P,[createKey("padding",z)]:E,[createKey("paddingRound",z)]:F,[createKey("iconSize",z)]:K,[createKey("borderRadius",z)]:q,[createKey("iconMargin",z)]:ne,waveOpacity:oe}=x,Q={"--n-width":R&&!te?Pe:"initial","--n-height":te?"initial":Pe,"--n-font-size":P,"--n-padding":R||te?"initial":ee?F:E,"--n-icon-size":K,"--n-icon-margin":ne,"--n-border-radius":te?"initial":R||ee?Pe:q};return Object.assign(Object.assign(Object.assign(Object.assign({"--n-bezier":$,"--n-bezier-ease-out":M,"--n-ripple-duration":T,"--n-opacity-disabled":I,"--n-wave-opacity":oe},ye),de),Ke),Q)}),_=C?useThemeClass("button",computed(()=>{let A="";const{dashed:$,type:M,ghost:x,text:T,color:I,round:O,circle:V,textColor:z,secondary:Y,tertiary:L,quaternary:H,strong:te}=e;$&&(A+="a"),x&&(A+="b"),T&&(A+="c"),O&&(A+="d"),V&&(A+="e"),Y&&(A+="f"),L&&(A+="g"),H&&(A+="h"),te&&(A+="i"),I&&(A+="j"+color2Class(I)),z&&(A+="k"+color2Class(z));const{value:j}=a;return A+="l"+j[0],A+="m"+M[0],A}),k,e):void 0;return{selfElRef:n,waveElRef:t,mergedClsPrefix:g,mergedFocusable:s,mergedSize:a,showBorder:r,enterPressed:o,rtlEnabled:v,handleMousedown:l,handleKeydown:f,handleBlur:b,handleKeyup:u,handleClick:d,customColorCssVars:computed(()=>{const{color:A}=e;if(!A)return null;const $=createHoverColor(A);return{"--n-border-color":A,"--n-border-color-hover":$,"--n-border-color-pressed":createPressedColor(A),"--n-border-color-focus":$,"--n-border-color-disabled":A}}),cssVars:C?void 0:k,themeClass:_==null?void 0:_.themeClass,onRender:_==null?void 0:_.onRender}},render(){const{mergedClsPrefix:e,tag:n,onRender:t}=this;t==null||t();const o=resolveWrappedSlot(this.$slots.default,r=>r&&h("span",{class:`${e}-button__content`},r));return h(n,{ref:"selfElRef",class:[this.themeClass,`${e}-button`,`${e}-button--${this.type}-type`,`${e}-button--${this.mergedSize}-type`,this.rtlEnabled&&`${e}-button--rtl`,this.disabled&&`${e}-button--disabled`,this.block&&`${e}-button--block`,this.enterPressed&&`${e}-button--pressed`,!this.text&&this.dashed&&`${e}-button--dashed`,this.color&&`${e}-button--color`,this.secondary&&`${e}-button--secondary`,this.loading&&`${e}-button--loading`,this.ghost&&`${e}-button--ghost`],tabindex:this.mergedFocusable?0:-1,type:this.attrType,style:this.cssVars,disabled:this.disabled,onClick:this.handleClick,onBlur:this.handleBlur,onMousedown:this.handleMousedown,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},this.iconPlacement==="right"&&o,h(NFadeInExpandTransition,{width:!0},{default:()=>resolveWrappedSlot(this.$slots.icon,r=>(this.loading||this.renderIcon||r)&&h("span",{class:`${e}-button__icon`,style:{margin:isSlotEmpty(this.$slots.default)?"0":""}},h(NIconSwitchTransition,null,{default:()=>this.loading?h(NBaseLoading,{clsPrefix:e,key:"loading",class:`${e}-icon-slot`,strokeWidth:20}):h("div",{key:"icon",class:`${e}-icon-slot`,role:"none"},this.renderIcon?this.renderIcon():r)})))}),this.iconPlacement==="left"&&o,this.text?null:h(NBaseWave,{ref:"waveElRef",clsPrefix:e}),this.showBorder?h("div",{"aria-hidden":!0,class:`${e}-button__border`,style:this.customColorCssVars}):null,this.showBorder?h("div",{"aria-hidden":!0,class:`${e}-button__state-border`,style:this.customColorCssVars}):null)}}),__unplugin_components_1=Button,commonVariables$e={titleFontSize:"22px"},self$I=e=>{const{borderRadius:n,fontSize:t,lineHeight:o,textColor2:r,textColor1:i,textColorDisabled:a,dividerColor:s,fontWeightStrong:l,primaryColor:d,baseColor:u,hoverColor:f,cardColor:b,modalColor:C,popoverColor:g}=e;return Object.assign(Object.assign({},commonVariables$e),{borderRadius:n,borderColor:composite(b,s),borderColorModal:composite(C,s),borderColorPopover:composite(g,s),textColor:r,titleFontWeight:l,titleTextColor:i,dayTextColor:a,fontSize:t,lineHeight:o,dateColorCurrent:d,dateTextColorCurrent:u,cellColorHover:composite(b,f),cellColorHoverModal:composite(C,f),cellColorHoverPopover:composite(g,f),cellColor:b,cellColorModal:C,cellColorPopover:g,barColor:d})},calendarDark={name:"Calendar",common:commonDark,peers:{Button:buttonDark$1},self:self$I},calendarDark$1=calendarDark,self$H=e=>{const{fontSize:n,boxShadow2:t,popoverColor:o,textColor2:r,borderRadius:i,borderColor:a,heightSmall:s,heightMedium:l,heightLarge:d,fontSizeSmall:u,fontSizeMedium:f,fontSizeLarge:b,dividerColor:C}=e;return{panelFontSize:n,boxShadow:t,color:o,textColor:r,borderRadius:i,border:`1px solid ${a}`,heightSmall:s,heightMedium:l,heightLarge:d,fontSizeSmall:u,fontSizeMedium:f,fontSizeLarge:b,dividerColor:C}},colorPickerDark={name:"ColorPicker",common:commonDark,peers:{Input:inputDark$1,Button:buttonDark$1},self:self$H},colorPickerDark$1=colorPickerDark,commonVariables$d={paddingSmall:"12px 16px 12px",paddingMedium:"19px 24px 20px",paddingLarge:"23px 32px 24px",paddingHuge:"27px 40px 28px",titleFontSizeSmall:"16px",titleFontSizeMedium:"18px",titleFontSizeLarge:"18px",titleFontSizeHuge:"18px",closeIconSize:"18px",closeSize:"22px"},self$G=e=>{const{primaryColor:n,borderRadius:t,lineHeight:o,fontSize:r,cardColor:i,textColor2:a,textColor1:s,dividerColor:l,fontWeightStrong:d,closeIconColor:u,closeIconColorHover:f,closeIconColorPressed:b,closeColorHover:C,closeColorPressed:g,modalColor:w,boxShadow1:y,popoverColor:v,actionColor:k}=e;return Object.assign(Object.assign({},commonVariables$d),{lineHeight:o,color:i,colorModal:w,colorPopover:v,colorTarget:n,colorEmbedded:k,colorEmbeddedModal:k,colorEmbeddedPopover:k,textColor:a,titleTextColor:s,borderColor:l,actionColor:k,titleFontWeight:d,closeColorHover:C,closeColorPressed:g,closeBorderRadius:t,closeIconColor:u,closeIconColorHover:f,closeIconColorPressed:b,fontSizeSmall:r,fontSizeMedium:r,fontSizeLarge:r,fontSizeHuge:r,boxShadow:y,borderRadius:t})},cardLight={name:"Card",common:commonLight,self:self$G},cardDark={name:"Card",common:commonDark,self(e){const n=self$G(e),{cardColor:t,modalColor:o,popoverColor:r}=e;return n.colorEmbedded=t,n.colorEmbeddedModal=o,n.colorEmbeddedPopover=r,n}},cardDark$1=cardDark,style$d=c$1([cB("card",`
 font-size: var(--n-font-size);
 ...
 `),cM("cursor-pointer",`
 cursor: pointer;
 `)]);function createLineClampClass(e){return`${e}-ellipsis--line-clamp`}function createCursorClass(e,n){return`${e}-ellipsis--cursor-${n}`}const ellipsisProps=Object.assign(Object.assign({},useTheme.props),{expandTrigger:String,lineClamp:[Number,String],tooltip:{type:[Boolean,Object],default:!0}}),__unplugin_components_7=defineComponent({name:"Ellipsis",inheritAttrs:!1,props:ellipsisProps,setup(e,{slots:n,attrs:t}){const{mergedClsPrefixRef:o}=useConfig(e),r=useTheme("Ellipsis","-ellipsis",style$c,ellipsisLight$1,e,o),i=ref(null),a=ref(null),s=ref(null),l=ref(!1),d=computed(()=>{const{lineClamp:y}=e,{value:v}=l;return y!==void 0?{textOverflow:"","-webkit-line-clamp":v?"":y}:{textOverflow:v?"":"ellipsis","-webkit-line-clamp":""}});function u(){let y=!1;const{value:v}=l;if(v)return!0;const{value:k}=i;if(k){const{lineClamp:_}=e;if(C(k),_!==void 0)y=k.scrollHeight<=k.offsetHeight;else{const{value:A}=a;A&&(y=A.getBoundingClientRect().width<=k.getBoundingClientRect().width)}g(k,y)}return y}const f=computed(()=>e.expandTrigger==="click"?()=>{var y;const{value:v}=l;v&&((y=s.value)===null||y===void 0||y.setShow(!1)),l.value=!v}:void 0);onDeactivated(()=>{var y;e.tooltip&&((y=s.value)===null||y===void 0||y.setShow(!1))});const b=()=>h("span",Object.assign({},mergeProps(t,{class:[`${o.value}-ellipsis`,e.lineClamp!==void 0?createLineClampClass(o.value):void 0,e.expandTrigger==="click"?createCursorClass(o.value,"pointer"):void 0],style:d.value}),{ref:"triggerRef",onClick:f.value,onMouseenter:e.expandTrigger==="click"?u:void 0}),e.lineClamp?n:h("span",{ref:"triggerInnerRef"},n));function C(y){if(!y)return;const v=d.value,k=createLineClampClass(o.value);e.lineClamp!==void 0?w(y,k,"add"):w(y,k,"remove");for(const _ in v)y.style[_]!==v[_]&&(y.style[_]=v[_])}function g(y,v){const k=createCursorClass(o.value,"pointer");e.expandTrigger==="click"&&!v?w(y,k,"add"):w(y,k,"remove")}function w(y,v,k){k==="add"?y.classList.contains(v)||y.classList.add(v):y.classList.contains(v)&&y.classList.remove(v)}return{mergedTheme:r,triggerRef:i,triggerInnerRef:a,tooltipRef:s,handleClick:f,renderTrigger:b,getTooltipDisabled:u}},render(){var e;const{tooltip:n,renderTrigger:t,$slots:o}=this;if(n){const{mergedTheme:r}=this;return h(NTooltip,Object.assign({ref:"tooltipRef",placement:"top"},n,{getDisabled:this.getTooltipDisabled,theme:r.peers.Tooltip,themeOverrides:r.peerOverrides.Tooltip}),{trigger:t,default:(e=o.tooltip)!==null&&e!==void 0?e:o.default})}else return t()}}),NDropdownDivider=defineComponent({name:"DropdownDivider",props:{clsPrefix:{type:String,required:!0}},render(){return h("div",{class:`${this.clsPrefix}-dropdown-divider`})}}),self$v=e=>{const{textColorBase:n,opacity1:t,opacity2:o,opacity3:r,opacity4:i,opacity5:a}=e;return{color:n,opacity1Depth:t,opacity2Depth:o,opacity3Depth:r,opacity4Depth:i,opacity5Depth:a}},iconLight={name:"Icon",common:commonLight,self:self$v},iconDark$1={name:"Icon",common:commonDark,self:self$v},iconDark$2=iconDark$1,style$b=cB("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
...
`,[fadeInScaleUpTransition(),cB("dropdown-option",`
 ...
 padding: var(--n-padding);
 `)])]),dropdownBaseProps={animated:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},size:{type:String,default:"medium"},inverted:Boolean,placement:{type:String,default:"bottom"},onSelect:[Function,Array],options:{type:Array,default:()=>[]},menuProps:Function,showArrow:Boolean,renderLabel:Function,renderIcon:Function,renderOption:Function,nodeProps:Function,labelField:{type:String,default:"label"},keyField:{type:String,default:"key"},childrenField:{type:String,default:"children"},value:[String,Number]},popoverPropKeys=Object.keys(popoverBaseProps),dropdownProps=Object.assign(Object.assign(Object.assign({},popoverBaseProps),dropdownBaseProps),useTheme.props),__unplugin_components_2=defineComponent({name:"Dropdown",inheritAttrs:!1,props:dropdownProps,setup(e){const n=ref(!1),t=useMergedState(toRef(e,"show"),n),o=computed(()=>{const{keyField:z,childrenField:Y}=e;return createTreeMate(e.options,{getKey(L){return L[z]},getDisabled(L){return L.disabled===!0},getIgnored(L){return L.type==="divider"||L.type==="render"},getChildren(L){return L[Y]}})}),r=computed(()=>o.value.treeNodes),i=ref(null),a=ref(null),s=ref(null),l=computed(()=>{var z,Y,L;return(L=(Y=(z=i.value)!==null&&z!==void 0?z:a.value)!==null&&Y!==void 0?Y:s.value)!==null&&L!==void 0?L:null}),d=computed(()=>o.value.getPath(l.value).keyPath),u=computed(()=>o.value.getPath(e.value).keyPath),f=useMemo(()=>e.keyboard&&t.value);useKeyboard({keydown:{ArrowUp:{prevent:!0,handler:$},ArrowRight:{prevent:!0,handler:A},ArrowDown:{prevent:!0,handler:M},ArrowLeft:{prevent:!0,handler:_},Enter:{prevent:!0,handler:x},Escape:k}},f);const{mergedClsPrefixRef:b,inlineThemeDisabled:C}=useConfig(e),g=useTheme("Dropdown","-dropdown",style$a,dropdownLight$1,e,b);provide(dropdownInjectionKey,{labelFieldRef:toRef(e,"labelField"),childrenFieldRef:toRef(e,"childrenField"),renderLabelRef:toRef(e,"renderLabel"),renderIconRef:toRef(e,"renderIcon"),hoverKeyRef:i,keyboardKeyRef:a,lastToggledSubmenuKeyRef:s,pendingKeyPathRef:d,activeKeyPathRef:u,animatedRef:toRef(e,"animated"),mergedShowRef:t,nodePropsRef:toRef(e,"nodeProps"),renderOptionRef:toRef(e,"renderOption"),menuPropsRef:toRef(e,"menuProps"),doSelect:w,doUpdateShow:y}),watch(t,z=>{!e.animated&&!z&&v()});function w(z,Y){const{onSelect:L}=e;L&&call(L,z,Y)}function y(z){const{"onUpdate:show":Y,onUpdateShow:L}=e;Y&&call(Y,z),L&&call(L,z),n.value=z}function v(){i.value=null,a.value=null,s.value=null}function k(){y(!1)}function _(){I("left")}function A(){I("right")}function $(){I("up")}function M(){I("down")}function x(){const z=T();z!=null&&z.isLeaf&&t.value&&(w(z.key,z.rawNode),y(!1))}function T(){var z;const{value:Y}=o,{value:L}=l;return!Y||L===null?null:(z=Y.getNode(L))!==null&&z!==void 0?z:null}function I(z){const{value:Y}=l,{value:{getFirstAvailableNode:L}}=o;let H=null;if(Y===null){const te=L();te!==null&&(H=te.key)}else{const te=T();if(te){let j;switch(z){case"down":j=te.getNext();break;case"up":j=te.getPrev();break;case"right":j=te.getChild();break;case"left":j=te.getParent();break}j&&(H=j.key)}}H!==null&&(i.value=null,a.value=H)}const O=computed(()=>{const{size:z,inverted:Y}=e,{common:{cubicBezierEaseInOut:L},self:H}=g.value,{padding:te,dividerColor:j,borderRadius:ee,optionOpacityDisabled:R,[createKey("optionIconSuffixWidth",z)]:G,[createKey("optionSuffixWidth",z)]:pe,[createKey("optionIconPrefixWidth",z)]:me,[createKey("optionPrefixWidth",z)]:Le,[createKey("fontSize",z)]:Ce,[createKey("optionHeight",z)]:ye,[createKey("optionIconSize",z)]:de}=H,ge={"--n-bezier":L,"--n-font-size":Ce,"--n-padding":te,"--n-border-radius":ee,"--n-option-height":ye,"--n-option-prefix-width":Le,"--n-option-icon-prefix-width":me,"--n-option-suffix-width":pe,"--n-option-icon-suffix-width":G,"--n-option-icon-size":de,"--n-divider-color":j,"--n-option-opacity-disabled":R};return Y?(ge["--n-color"]=H.colorInverted,ge["--n-option-color-hover"]=H.optionColorHoverInverted,ge["--n-option-color-active"]=H.optionColorActiveInverted,ge["--n-option-text-color"]=H.optionTextColorInverted,ge["--n-option-text-color-hover"]=H.optionTextColorHoverInverted,ge["--n-option-text-color-active"]=H.optionTextColorActiveInverted,ge["--n-option-text-color-child-active"]=H.optionTextColorChildActiveInverted,ge["--n-prefix-color"]=H.prefixColorInverted,ge["--n-suffix-color"]=H.suffixColorInverted,ge["--n-group-header-text-color"]=H.groupHeaderTextColorInverted):(ge["--n-color"]=H.color,ge["--n-option-color-hover"]=H.optionColorHover,ge["--n-option-color-active"]=H.optionColorActive,ge["--n-option-text-color"]=H.optionTextColor,ge["--n-option-text-color-hover"]=H.optionTextColorHover,ge["--n-option-text-color-active"]=H.optionTextColorActive,ge["--n-option-text-color-child-active"]=H.optionTextColorChildActive,ge["--n-prefix-color"]=H.prefixColor,ge["--n-suffix-color"]=H.suffixColor,ge["--n-group-header-text-color"]=H.groupHeaderTextColor),ge}),V=C?useThemeClass("dropdown",computed(()=>`${e.size[0]}${e.inverted?"i":""}`),O,e):void 0;return{mergedClsPrefix:b,mergedTheme:g,tmNodes:r,mergedShow:t,handleAfterLeave:()=>{e.animated&&v()},doUpdateShow:y,cssVars:C?void 0:O,themeClass:V==null?void 0:V.themeClass,onRender:V==null?void 0:V.onRender}},render(){const e=(o,r,i,a,s)=>{var l;const{mergedClsPrefix:d,menuProps:u}=this;(l=this.onRender)===null||l===void 0||l.call(this);const f=(u==null?void 0:u(void 0,this.tmNodes.map(C=>C.rawNode)))||{},b={ref:createRefSetter(r),class:[o,`${d}-dropdown`,this.themeClass],clsPrefix:d,tmNodes:this.tmNodes,style:[i,this.cssVars],showArrow:this.showArrow,arrowStyle:this.arrowStyle,scrollable:this.scrollable,onMouseenter:a,onMouseleave:s};return h(NDropdownMenu,mergeProps(this.$attrs,b,f))},{mergedTheme:n}=this,t={show:this.mergedShow,theme:n.peers.Popover,themeOverrides:n.peerOverrides.Popover,internalOnAfterLeave:this.handleAfterLeave,internalRenderBody:e,onUpdateShow:this.doUpdateShow,"onUpdate:show":void 0};return h(NPopover,Object.assign({},keep(this.$props,popoverPropKeys),t),{trigger:()=>{var o,r;return(r=(o=this.$slots).default)===null||r===void 0?void 0:r.call(o)}})}}),commonVars$7={itemFontSize:"12px",itemHeight:"36px",itemWidth:"52px",panelActionPadding:"8px 0"},self$u=e=>{const{popoverColor:n,textColor2:t,primaryColor:o,hoverColor:r,dividerColor:i,opacityDisabled:a,boxShadow2:s,borderRadius:l,iconColor:d,iconColorDisabled:u}=e;return Object.assign(Object.assign({},commonVars$7),{panelColor:n,panelBoxShadow:s,panelDividerColor:i,itemTextColor:t,itemTextColorActive:o,itemColorHover:r,itemOpacityDisabled:a,itemBorderRadius:l,borderRadius:l,iconColor:d,iconColorDisabled:u})},timePickerDark={name:"TimePicker",common:commonDark,peers:{Scrollbar:scrollbarDark$1,Button:buttonDark$1,Input:inputDark$1},self:self$u},timePickerDark$1=timePickerDark,commonVars$6={itemSize:"24px",itemCellWidth:"38px",itemCellHeight:"32px",scrollItemWidth:"80px",scrollItemHeight:"40px",panelExtraFooterPadding:"8px 12px",panelActionPadding:"8px 12px",calendarTitlePadding:"0",calendarTitleHeight:"28px",arrowSize:"14px",panelHeaderPadding:"8px 12px",calendarDaysHeight:"32px",calendarTitleGridTempateColumns:"28px 28px 1fr 28px 28px",calendarLeftPaddingDate:"6px 12px 4px 12px",calendarLeftPaddingDatetime:"4px 12px",calendarLeftPaddingDaterange:"6px 12px 4px 12px",calendarLeftPaddingDatetimerange:"4px 12px",calendarLeftPaddingMonth:"0",calendarLeftPaddingYear:"0",calendarLeftPaddingQuarter:"0",calendarLeftPaddingMonthrange:"0",calendarLeftPaddingQuarterrange:"0",calendarLeftPaddingYearrange:"0",calendarRightPaddingDate:"6px 12px 4px 12px",calendarRightPaddingDatetime:"4px 12px",calendarRightPaddingDaterange:"6px 12px 4px 12px",calendarRightPaddingDatetimerange:"4px 12px",calendarRightPaddingMonth:"0",calendarRightPaddingYear:"0",calendarRightPaddingQuarter:"0",calendarRightPaddingMonthrange:"0",calendarRightPaddingQuarterrange:"0",calendarRightPaddingYearrange:"0"},self$t=e=>{const{hoverColor:n,fontSize:t,textColor2:o,textColorDisabled:r,popoverColor:i,primaryColor:a,borderRadiusSmall:s,iconColor:l,iconColorDisabled:d,textColor1:u,dividerColor:f,boxShadow2:b,borderRadius:C,fontWeightStrong:g}=e;return Object.assign(Object.assign({},commonVars$6),{itemFontSize:t,calendarDaysFontSize:t,calendarTitleFontSize:t,itemTextColor:o,itemTextColorDisabled:r,itemTextColorActive:i,itemTextColorCurrent:a,itemColorIncluded:changeColor(a,{alpha:.1}),itemColorHover:n,itemColorDisabled:n,itemColorActive:a,itemBorderRadius:s,panelColor:i,panelTextColor:o,arrowColor:l,calendarTitleTextColor:u,calendarTitleColorHover:n,calendarDaysTextColor:o,panelHeaderDividerColor:f,calendarDaysDividerColor:f,calendarDividerColor:f,panelActionDividerColor:f,panelBoxShadow:b,panelBorderRadius:C,calendarTitleFontWeight:g,scrollItemBorderRadius:C,iconColor:l,iconColorDisabled:d})},datePickerDark={name:"DatePicker",common:commonDark,peers:{Input:inputDark$1,Button:buttonDark$1,TimePicker:timePickerDark$1,Scrollbar:scrollbarDark$1},self(e){const{popoverColor:n,hoverColor:t,primaryColor:o}=e,r=self$t(e);return r.itemColorDisabled=composite(n,t),r.itemColorIncluded=changeColor(o,{alpha:.15}),r.itemColorHover=composite(n,t),r}},datePickerDark$1=datePickerDark;var commonjsGlobal=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};const commonVariables$7={thPaddingBorderedSmall:"8px 12px",thPaddingBorderedMedium:"12px 16px",thPaddingBorderedLarge:"16px 24px",thPaddingSmall:"0",thPaddingMedium:"0",thPaddingLarge:"0",tdPaddingBorderedSmall:"8px 12px",tdPaddingBorderedMedium:"12px 16px",tdPaddingBorderedLarge:"16px 24px",tdPaddingSmall:"0 0 8px 0",tdPaddingMedium:"0 0 12px 0",tdPaddingLarge:"0 0 16px 0"},self$s=e=>{const{tableHeaderColor:n,textColor2:t,textColor1:o,cardColor:r,modalColor:i,popoverColor:a,dividerColor:s,borderRadius:l,fontWeightStrong:d,lineHeight:u,fontSizeSmall:f,fontSizeMedium:b,fontSizeLarge:C}=e;return Object.assign(Object.assign({},commonVariables$7),{lineHeight:u,fontSizeSmall:f,fontSizeMedium:b,fontSizeLarge:C,titleTextColor:o,thColor:composite(r,n),thColorModal:composite(i,n),thColorPopover:composite(a,n),thTextColor:o,thFontWeight:d,tdTextColor:t,tdColor:r,tdColorModal:i,tdColorPopover:a,borderColor:composite(r,s),borderColorModal:composite(i,s),borderColorPopover:composite(a,s),borderRadius:l})},descriptionsDark={name:"Descriptions",common:commonDark,self:self$s},descriptionsDark$1=descriptionsDark,commonVars$5={titleFontSize:"18px",padding:"16px 28px 20px 28px",iconSize:"28px",actionSpace:"12px",contentMargin:"8px 0 16px 0",iconMargin:"0 4px 0 0",iconMarginIconTop:"4px 0 8px 0",closeSize:"22px",closeIconSize:"18px",closeMargin:"20px 26px 0 0",closeMarginIconTop:"10px 16px 0 0"},self$r=e=>{const{textColor1:n,textColor2:t,modalColor:o,closeIconColor:r,closeIconColorHover:i,closeIconColorPressed:a,closeColorHover:s,closeColorPressed:l,infoColor:d,successColor:u,warningColor:f,errorColor:b,primaryColor:C,dividerColor:g,borderRadius:w,fontWeightStrong:y,lineHeight:v,fontSize:k}=e;return Object.assign(Object.assign({},commonVars$5),{fontSize:k,lineHeight:v,border:`1px solid ${g}`,titleTextColor:n,textColor:t,color:o,closeColorHover:s,closeColorPressed:l,closeIconColor:r,closeIconColorHover:i,closeIconColorPressed:a,closeBorderRadius:w,iconColor:C,iconColorInfo:d,iconColorSuccess:u,iconColorWarning:f,iconColorError:b,borderRadius:w,titleFontWeight:y})},dialogLight={name:"Dialog",common:commonLight,peers:{Button:buttonLight},self:self$r},dialogDark={name:"Dialog",common:commonDark,peers:{Button:buttonDark$1},self:self$r},dialogDark$1=dialogDark,dialogProps={icon:Function,type:{type:String,default:"default"},title:[String,Function],closable:{type:Boolean,default:!0},negativeText:String,positiveText:String,positiveButtonProps:Object,negativeButtonProps:Object,content:[String,Function],action:Function,showIcon:{type:Boolean,default:!0},loading:Boolean,bordered:Boolean,iconPlacement:String,onPositiveClick:Function,onNegativeClick:Function,onClose:Function},dialogPropKeys=keysOf(dialogProps),style$9=c$1([cB("dialog",`
 word-break: break-word;
 line-height: var(--n-line-height);
 position: relative;
 ...
 width: 446px;
 max-width: calc(100vw - 32px);
 `)])]),iconRenderMap$2={default:()=>h(InfoIcon,null),info:()=>h(InfoIcon,null),success:()=>h(SuccessIcon,null),warning:()=>h(WarningIcon,null),error:()=>h(ErrorIcon,null)},NDialog=defineComponent({name:"Dialog",alias:["NimbusConfirmCard","Confirm"],props:Object.assign(Object.assign({},useTheme.props),dialogProps),setup(e){const{mergedComponentPropsRef:n,mergedClsPrefixRef:t,inlineThemeDisabled:o}=useConfig(e),r=computed(()=>{var f,b;const{iconPlacement:C}=e;return C||((b=(f=n==null?void 0:n.value)===null||f===void 0?void 0:f.Dialog)===null||b===void 0?void 0:b.iconPlacement)||"left"});function i(f){const{onPositiveClick:b}=e;b&&b(f)}function a(f){const{onNegativeClick:b}=e;b&&b(f)}function s(){const{onClose:f}=e;f&&f()}const l=useTheme("Dialog","-dialog",style$9,dialogLight,e,t),d=computed(()=>{const{type:f}=e,b=r.value,{common:{cubicBezierEaseInOut:C},self:{fontSize:g,lineHeight:w,border:y,titleTextColor:v,textColor:k,color:_,closeBorderRadius:A,closeColorHover:$,closeColorPressed:M,closeIconColor:x,closeIconColorHover:T,closeIconColorPressed:I,closeIconSize:O,borderRadius:V,titleFontWeight:z,titleFontSize:Y,padding:L,iconSize:H,actionSpace:te,contentMargin:j,closeSize:ee,[b==="top"?"iconMarginIconTop":"iconMargin"]:R,[b==="top"?"closeMarginIconTop":"closeMargin"]:G,[createKey("iconColor",f)]:pe}}=l.value;return{"--n-font-size":g,"--n-icon-color":pe,"--n-bezier":C,"--n-close-margin":G,"--n-icon-margin":R,"--n-icon-size":H,"--n-close-size":ee,"--n-close-icon-size":O,"--n-close-border-radius":A,"--n-close-color-hover":$,"--n-close-color-pressed":M,"--n-close-icon-color":x,"--n-close-icon-color-hover":T,"--n-close-icon-color-pressed":I,"--n-color":_,"--n-text-color":k,"--n-border-radius":V,"--n-padding":L,"--n-line-height":w,"--n-border":y,"--n-content-margin":j,"--n-title-font-size":Y,"--n-title-font-weight":z,"--n-title-text-color":v,"--n-action-space":te}}),u=o?useThemeClass("dialog",computed(()=>`${e.type[0]}${r.value[0]}`),d,e):void 0;return{mergedClsPrefix:t,mergedIconPlacement:r,mergedTheme:l,handlePositiveClick:i,handleNegativeClick:a,handleCloseClick:s,cssVars:o?void 0:d,themeClass:u==null?void 0:u.themeClass,onRender:u==null?void 0:u.onRender}},render(){var e;const{bordered:n,mergedIconPlacement:t,cssVars:o,closable:r,showIcon:i,title:a,content:s,action:l,negativeText:d,positiveText:u,positiveButtonProps:f,negativeButtonProps:b,handlePositiveClick:C,handleNegativeClick:g,mergedTheme:w,loading:y,type:v,mergedClsPrefix:k}=this;(e=this.onRender)===null||e===void 0||e.call(this);const _=i?h(NBaseIcon,{clsPrefix:k,class:`${k}-dialog__icon`},{default:()=>resolveWrappedSlot(this.$slots.icon,$=>$||(this.icon?render$1(this.icon):iconRenderMap$2[this.type]()))}):null,A=resolveWrappedSlot(this.$slots.action,$=>$||u||d||l?h("div",{class:`${k}-dialog__action`},$||(l?[render$1(l)]:[this.negativeText&&h(__unplugin_components_1,Object.assign({theme:w.peers.Button,themeOverrides:w.peerOverrides.Button,ghost:!0,size:"small",onClick:g},b),{default:()=>render$1(this.negativeText)}),this.positiveText&&h(__unplugin_components_1,Object.assign({theme:w.peers.Button,themeOverrides:w.peerOverrides.Button,size:"small",type:v==="default"?"primary":v,disabled:y,loading:y,onClick:C},f),{default:()=>render$1(this.positiveText)})])):null);return h("div",{class:[`${k}-dialog`,this.themeClass,this.closable&&`${k}-dialog--closable`,`${k}-dialog--icon-${t}`,n&&`${k}-dialog--bordered`],style:o,role:"dialog"},r?h(NBaseClose,{clsPrefix:k,class:`${k}-dialog__close`,onClick:this.handleCloseClick}):null,i&&t==="top"?h("div",{class:`${k}-dialog-icon-container`},_):null,h("div",{class:`${k}-dialog__title`},i&&t==="left"?_:null,resolveSlot(this.$slots.header,()=>[render$1(a)])),h("div",{class:[`${k}-dialog__content`,A?"":`${k}-dialog__content--last`]},resolveSlot(this.$slots.default,()=>[render$1(s)])),A)}}),dialogProviderInjectionKey="n-dialog-provider",dialogApiInjectionKey="n-dialog-api",dialogReactiveListInjectionKey="n-dialog-reactive-list",self$q=e=>{const{modalColor:n,textColor2:t,boxShadow3:o}=e;return{color:n,textColor:t,boxShadow:o}},modalLight={name:"Modal",common:commonLight,peers:{Scrollbar:scrollbarLight$1,Dialog:dialogLight,Card:cardLight},self:self$q},modalDark={name:"Modal",common:commonDark,peers:{Scrollbar:scrollbarDark$1,Dialog:dialogDark$1,Card:cardDark$1},self:self$q},modalDark$1=modalDark,presetProps=Object.assign(Object.assign({},cardBaseProps),dialogProps),presetPropsKeys=keysOf(presetProps),NModalBodyWrapper=defineComponent({name:"ModalBody",inheritAttrs:!1,props:Object.assign(Object.assign({show:{type:Boolean,required:!0},preset:String,displayDirective:{type:String,required:!0},trapFocus:{type:Boolean,default:!0},autoFocus:{type:Boolean,default:!0},blockScroll:Boolean},presetProps),{renderMask:Function,onClickoutside:Function,onBeforeLeave:{type:Function,required:!0},onAfterLeave:{type:Function,required:!0},onPositiveClick:{type:Function,required:!0},onNegativeClick:{type:Function,required:!0},onClose:{type:Function,required:!0},onAfterEnter:Function,onEsc:Function}),setup(e){const n=ref(null),t=ref(null),o=ref(e.show),r=ref(null),i=ref(null);watch(toRef(e,"show"),y=>{y&&(o.value=!0)}),useLockHtmlScroll(computed(()=>e.blockScroll&&o.value));const a=inject(modalInjectionKey);function s(){if(a.transformOriginRef.value==="center")return"";const{value:y}=r,{value:v}=i;if(y===null||v===null)return"";if(t.value){const k=t.value.containerScrollTop;return`${y}px ${v+k}px`}return""}function l(y){if(a.transformOriginRef.value==="center")return;const v=a.getMousePosition();if(!v||!t.value)return;const k=t.value.containerScrollTop,{offsetLeft:_,offsetTop:A}=y;if(v){const $=v.y,M=v.x;r.value=-(_-M),i.value=-(A-$-k)}y.style.transformOrigin=s()}function d(y){nextTick(()=>{l(y)})}function u(y){y.style.transformOrigin=s(),e.onBeforeLeave()}function f(){o.value=!1,r.value=null,i.value=null,e.onAfterLeave()}function b(){const{onClose:y}=e;y&&y()}function C(){e.onNegativeClick()}function g(){e.onPositiveClick()}const w=ref(null);return watch(w,y=>{y&&nextTick(()=>{const v=y.el;v&&n.value!==v&&(n.value=v)})}),provide(modalBodyInjectionKey,n),provide(drawerBodyInjectionKey,null),provide(popoverBodyInjectionKey,null),{mergedTheme:a.mergedThemeRef,appear:a.appearRef,isMounted:a.isMountedRef,mergedClsPrefix:a.mergedClsPrefixRef,bodyRef:n,scrollbarRef:t,displayed:o,childNodeRef:w,handlePositiveClick:g,handleNegativeClick:C,handleCloseClick:b,handleAfterLeave:f,handleBeforeLeave:u,handleEnter:d}},render(){const{$slots:e,$attrs:n,handleEnter:t,handleAfterLeave:o,handleBeforeLeave:r,preset:i,mergedClsPrefix:a}=this;let s=null;if(!i){if(s=getFirstSlotVNode(e),!s){warn$2("modal","default slot is empty");return}s=cloneVNode(s),s.props=mergeProps({class:`${a}-modal`},n,s.props||{})}return this.displayDirective==="show"||this.displayed||this.show?withDirectives(h("div",{role:"none",class:`${a}-modal-body-wrapper`},h(NScrollbar,{ref:"scrollbarRef",theme:this.mergedTheme.peers.Scrollbar,themeOverrides:this.mergedTheme.peerOverrides.Scrollbar,contentClass:`${a}-modal-scroll-content`},{default:()=>{var l;return[(l=this.renderMask)===null||l===void 0?void 0:l.call(this),h(FocusTrap,{disabled:!this.trapFocus,active:this.show,onEsc:this.onEsc,autoFocus:this.autoFocus},{default:()=>{var d;return h(Transition,{name:"fade-in-scale-up-transition",appear:(d=this.appear)!==null&&d!==void 0?d:this.isMounted,onEnter:t,onAfterEnter:this.onAfterEnter,onAfterLeave:o,onBeforeLeave:r},{default:()=>{const u=[[vShow,this.show]],{onClickoutside:f}=this;return f&&u.push([clickoutside$1,this.onClickoutside,void 0,{capture:!0}]),withDirectives(this.preset==="confirm"||this.preset==="dialog"?h(NDialog,Object.assign({},this.$attrs,{class:[`${a}-modal`,this.$attrs.class],ref:"bodyRef",theme:this.mergedTheme.peers.Dialog,themeOverrides:this.mergedTheme.peerOverrides.Dialog},keep(this.$props,dialogPropKeys),{"aria-modal":"true"}),e):this.preset==="card"?h(NCard,Object.assign({},this.$attrs,{ref:"bodyRef",class:[`${a}-modal`,this.$attrs.class],theme:this.mergedTheme.peers.Card,themeOverrides:this.mergedTheme.peerOverrides.Card},keep(this.$props,cardBasePropKeys),{"aria-modal":"true",role:"dialog"}),e):this.childNodeRef=s,u)}})}})]}})),[[vShow,this.displayDirective==="if"||this.displayed||this.show]]):null}}),style$8=c$1([cB("modal-container",`
 position: fixed;
 left: 0;
 top: 0;
 height: 0;
...
`,[fadeInTransition({enterDuration:"0.3s",leaveDuration:"0.8s"}),cB("loading-bar",`
 ...
 max-width .2s linear,
 background .2s linear;
 `)])]);var __awaiter=globalThis&&globalThis.__awaiter||function(e,n,t,o){function r(i){return i instanceof t?i:new t(function(a){a(i)})}return new(t||(t=Promise))(function(i,a){function s(u){try{d(o.next(u))}catch(f){a(f)}}function l(u){try{d(o.throw(u))}catch(f){a(f)}}function d(u){u.done?i(u.value):r(u.value).then(s,l)}d((o=o.apply(e,n||[])).next())})};function createClassName(e,n){return`${n}-loading-bar ${n}-loading-bar--${e}`}const NLoadingBar=defineComponent({name:"LoadingBar",props:{containerStyle:[String,Object]},setup(){const{inlineThemeDisabled:e}=useConfig(),{props:n,mergedClsPrefixRef:t}=inject(loadingBarProviderInjectionKey),o=ref(null),r=ref(!1),i=ref(!1),a=ref(!1),s=ref(!1);let l=!1;const d=ref(!1),u=computed(()=>{const{loadingBarStyle:$}=n;return $?$[d.value?"error":"loading"]:""});function f(){return __awaiter(this,void 0,void 0,function*(){r.value=!1,a.value=!1,l=!1,d.value=!1,s.value=!0,yield nextTick(),s.value=!1})}function b($=0,M=80,x="starting"){return __awaiter(this,void 0,void 0,function*(){yield f(),a.value=!0,i.value=!0,yield nextTick();const T=o.value;T&&(T.style.maxWidth=`${$}%`,T.style.transition="none",T.offsetWidth,T.className=createClassName(x,t.value),T.style.transition="",T.style.maxWidth=`${M}%`)})}function C(){if(l||d.value||!a.value)return;l=!0;const $=o.value;$&&($.className=createClassName("finishing",t.value),$.style.maxWidth="100%",$.offsetWidth,a.value=!1)}function g(){if(!(l||d.value))if(!a.value)b(100,100,"error").then(()=>{d.value=!0;const $=o.value;$&&($.className=createClassName("error",t.value),$.offsetWidth,a.value=!1)});else{d.value=!0;const $=o.value;if(!$)return;$.className=createClassName("error",t.value),$.style.maxWidth="100%",$.offsetWidth,a.value=!1}}function w(){r.value=!0}function y(){r.value=!1}function v(){return __awaiter(this,void 0,void 0,function*(){yield f()})}const k=useTheme("LoadingBar","-loading-bar",style$4,loadingBarLight$1,n,t),_=computed(()=>{const{self:{height:$,colorError:M,colorLoading:x}}=k.value;return{"--n-height":$,"--n-color-loading":x,"--n-color-error":M}}),A=e?useThemeClass("loading-bar",void 0,_,n):void 0;return{mergedClsPrefix:t,loadingBarRef:o,started:i,loading:a,entering:r,transitionDisabled:s,start:b,error:g,finish:C,handleEnter:w,handleAfterEnter:y,handleAfterLeave:v,mergedLoadingBarStyle:u,cssVars:e?void 0:_,themeClass:A==null?void 0:A.themeClass,onRender:A==null?void 0:A.onRender}},render(){if(!this.started)return null;const{mergedClsPrefix:e}=this;return h(Transition,{name:"fade-in-transition",appear:!0,onEnter:this.handleEnter,onAfterEnter:this.handleAfterEnter,onAfterLeave:this.handleAfterLeave,css:!this.transitionDisabled},{default:()=>{var n;return(n=this.onRender)===null||n===void 0||n.call(this),withDirectives(h("div",{class:[`${e}-loading-bar-container`,this.themeClass],style:this.containerStyle},h("div",{ref:"loadingBarRef",class:[`${e}-loading-bar`],style:[this.cssVars,this.mergedLoadingBarStyle]})),[[vShow,this.loading||!this.loading&&this.entering]])}})}}),loadingBarProviderProps=Object.assign(Object.assign({},useTheme.props),{to:{type:[String,Object,Boolean],default:void 0},containerStyle:[String,Object],loadingBarStyle:{type:Object}}),__unplugin_components_14=defineComponent({name:"LoadingBarProvider",props:loadingBarProviderProps,setup(e){const n=isMounted(),t=ref(null),o={start(){var i;n.value?(i=t.value)===null||i===void 0||i.start():nextTick(()=>{var a;(a=t.value)===null||a===void 0||a.start()})},error(){var i;n.value?(i=t.value)===null||i===void 0||i.error():nextTick(()=>{var a;(a=t.value)===null||a===void 0||a.error()})},finish(){var i;n.value?(i=t.value)===null||i===void 0||i.finish():nextTick(()=>{var a;(a=t.value)===null||a===void 0||a.finish()})}},{mergedClsPrefixRef:r}=useConfig(e);return provide(loadingBarApiInjectionKey,o),provide(loadingBarProviderInjectionKey,{props:e,mergedClsPrefixRef:r}),Object.assign(o,{loadingBarRef:t})},render(){var e,n;return h(Fragment,null,h(Teleport,{disabled:this.to===!1,to:this.to||"body"},h(NLoadingBar,{ref:"loadingBarRef",containerStyle:this.containerStyle})),(n=(e=this.$slots).default)===null||n===void 0?void 0:n.call(e))}});function useLoadingBar(){const e=inject(loadingBarApiInjectionKey,null);return e===null&&throwError("use-loading-bar","No outer <n-loading-bar-provider /> founded."),e}const messageProps={icon:Function,type:{type:String,default:"info"},content:[String,Number,Function],showIcon:{type:Boolean,default:!0},closable:Boolean,keepAliveOnHover:Boolean,onClose:Function,onMouseenter:Function,onMouseleave:Function},messageApiInjectionKey="n-message-api",messageProviderInjectionKey="n-message-provider",style$3=c$1([cB("message-wrapper",`
 margin: var(--n-margin);
 z-index: 0;
...
`,[cM("strong",`
 ...
 `)]),textProps=Object.assign(Object.assign({},useTheme.props),{code:Boolean,type:{type:String,default:"default"},delete:Boolean,strong:Boolean,italic:Boolean,underline:Boolean,depth:[String,Number],tag:String,as:{type:String,validator:()=>!0,default:void 0}}),NText=defineComponent({name:"Text",props:textProps,setup(e){const{mergedClsPrefixRef:n,inlineThemeDisabled:t}=useConfig(e),o=useTheme("Typography","-text",style,typographyLight$1,e,n),r=computed(()=>{const{depth:a,type:s}=e,l=s==="default"?a===void 0?"textColor":`textColor${a}Depth`:createKey("textColor",s),{common:{fontWeightStrong:d,fontFamilyMono:u,cubicBezierEaseInOut:f},self:{codeTextColor:b,codeBorderRadius:C,codeColor:g,codeBorder:w,[l]:y}}=o.value;return{"--n-bezier":f,"--n-text-color":y,"--n-font-weight-strong":d,"--n-font-famliy-mono":u,"--n-code-border-radius":C,"--n-code-text-color":b,"--n-code-color":g,"--n-code-border":w}}),i=t?useThemeClass("text",computed(()=>`${e.type[0]}${e.depth||""}`),r,e):void 0;return{mergedClsPrefix:n,compitableTag:useCompitable(e,["as","tag"]),cssVars:t?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e,n,t;const{mergedClsPrefix:o}=this;(e=this.onRender)===null||e===void 0||e.call(this);const r=[`${o}-text`,this.themeClass,{[`${o}-text--code`]:this.code,[`${o}-text--delete`]:this.delete,[`${o}-text--strong`]:this.strong,[`${o}-text--italic`]:this.italic,[`${o}-text--underline`]:this.underline}],i=(t=(n=this.$slots).default)===null||t===void 0?void 0:t.call(n);return this.code?h("code",{class:r,style:this.cssVars},this.delete?h("del",null,i):i):this.delete?h("del",{class:r,style:this.cssVars},i):h(this.compitableTag||"span",{class:r,style:this.cssVars},i)}}),self$1=()=>({}),equationDark={name:"Equation",common:commonDark,self:self$1},equationDark$1=equationDark,darkTheme={name:"dark",common:commonDark,Alert:alertDark$1,Anchor:anchorDark$1,AutoComplete:autoCompleteDark$1,Avatar:avatarDark$1,AvatarGroup:avatarGroupDark$1,BackTop:backTopDark$1,Badge:badgeDark$1,Breadcrumb:breadcrumbDark$1,Button:buttonDark$1,ButtonGroup:buttonGroupDark$1,Calendar:calendarDark$1,Card:cardDark$1,Carousel:carouselDark$1,Cascader:cascaderDark$1,Checkbox:checkboxDark$1,Code:codeDark$1,Collapse:collapseDark$1,CollapseTransition:collapseTransitionDark$1,ColorPicker:colorPickerDark$1,DataTable:dataTableDark$1,DatePicker:datePickerDark$1,Descriptions:descriptionsDark$1,Dialog:dialogDark$1,Divider:dividerDark$1,Drawer:drawerDark$1,Dropdown:dropdownDark$1,DynamicInput:dynamicInputDark$1,DynamicTags:dynamicTagsDark$1,Element:elementDark$1,Empty:emptyDark$1,Ellipsis:ellipsisDark$1,Equation:equationDark$1,Form:formDark,GradientText:gradientTextDark$1,Icon:iconDark$2,IconWrapper:iconWrapperDark,Image:imageDark,Input:inputDark$1,InputNumber:inputNumberDark$1,LegacyTransfer:legacyTransferDark,Layout:layoutDark$1,List:listDark$2,LoadingBar:loadingBarDark$1,Log:logDark$1,Menu:menuDark$1,Mention:mentionDark,Message:messageDark$1,Modal:modalDark$1,Notification:notificationDark$1,PageHeader:pageHeaderDark,Pagination:paginationDark$1,Popconfirm:popconfirmDark$1,Popover:popoverDark$1,Popselect:popselectDark,Progress:progressDark$1,Radio:radioDark$1,Rate:rateDark$1,Result:resultDark$1,Row:rowDark$1,Scrollbar:scrollbarDark$1,Select:selectDark$1,Skeleton:skeletonDark,Slider:sliderDark$1,Space:spaceDark$1,Spin:spinDark$1,Statistic:statisticDark$1,Steps:stepsDark$1,Switch:switchDark$1,Table:tableDark$1,Tabs:tabsDark$1,Tag:tagDark$1,Thing:thingDark$1,TimePicker:timePickerDark$1,Timeline:timelineDark$1,Tooltip:tooltipDark$1,Transfer:transferDark$2,Tree:treeDark$1,TreeSelect:treeSelectDark$1,Typography:typographyDark$1,Upload:uploadDark$1,Watermark:watermarkDark$1};var isVue2=!1;/*!
  * pinia v2.0.32
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */let activePinia;const setActivePinia=e=>activePinia=e,piniaSymbol=Symbol();function isPlainObject(e){return e&&typeof e=="object"&&Object.prototype.toString.call(e)==="[object Object]"&&typeof e.toJSON!="function"}var MutationType;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(MutationType||(MutationType={}));function createPinia(){const e=effectScope(!0),n=e.run(()=>ref({}));let t=[],o=[];const r=markRaw({install(i){setActivePinia(r),r._a=i,i.provide(piniaSymbol,r),i.config.globalProperties.$pinia=r,o.forEach(a=>t.push(a)),o=[]},use(i){return!this._a&&!isVue2?o.push(i):t.push(i),this},_p:t,_a:null,_e:e,_s:new Map,state:n});return r}const noop$1=()=>{};function addSubscription(e,n,t,o=noop$1){e.push(n);const r=()=>{const i=e.indexOf(n);i>-1&&(e.splice(i,1),o())};return!t&&getCurrentScope()&&onScopeDispose(r),r}function triggerSubscriptions(e,...n){e.slice().forEach(t=>{t(...n)})}function mergeReactiveObjects(e,n){e instanceof Map&&n instanceof Map&&n.forEach((t,o)=>e.set(o,t)),e instanceof Set&&n instanceof Set&&n.forEach(e.add,e);for(const t in n){if(!n.hasOwnProperty(t))continue;const o=n[t],r=e[t];isPlainObject(r)&&isPlainObject(o)&&e.hasOwnProperty(t)&&!isRef(o)&&!isReactive(o)?e[t]=mergeReactiveObjects(r,o):e[t]=o}return e}const skipHydrateSymbol=Symbol();function shouldHydrate(e){return!isPlainObject(e)||!e.hasOwnProperty(skipHydrateSymbol)}const{assign}=Object;function isComputed(e){return!!(isRef(e)&&e.effect)}function createOptionsStore(e,n,t,o){const{state:r,actions:i,getters:a}=n,s=t.state.value[e];let l;function d(){s||(t.state.value[e]=r?r():{});const u=toRefs(t.state.value[e]);return assign(u,i,Object.keys(a||{}).reduce((f,b)=>(f[b]=markRaw(computed(()=>{setActivePinia(t);const C=t._s.get(e);return a[b].call(C,C)})),f),{}))}return l=createSetupStore(e,d,n,t,o,!0),l.$reset=function(){const f=r?r():{};this.$patch(b=>{assign(b,f)})},l}function createSetupStore(e,n,t={},o,r,i){let a;const s=assign({actions:{}},t),l={deep:!0};let d,u,f=markRaw([]),b=markRaw([]),C;const g=o.state.value[e];!i&&!g&&(o.state.value[e]={}),ref({});let w;function y(x){let T;d=u=!1,typeof x=="function"?(x(o.state.value[e]),T={type:MutationType.patchFunction,storeId:e,events:C}):(mergeReactiveObjects(o.state.value[e],x),T={type:MutationType.patchObject,payload:x,storeId:e,events:C});const I=w=Symbol();nextTick().then(()=>{w===I&&(d=!0)}),u=!0,triggerSubscriptions(f,T,o.state.value[e])}const v=noop$1;function k(){a.stop(),f=[],b=[],o._s.delete(e)}function _(x,T){return function(){setActivePinia(o);const I=Array.from(arguments),O=[],V=[];function z(H){O.push(H)}function Y(H){V.push(H)}triggerSubscriptions(b,{args:I,name:x,store:$,after:z,onError:Y});let L;try{L=T.apply(this&&this.$id===e?this:$,I)}catch(H){throw triggerSubscriptions(V,H),H}return L instanceof Promise?L.then(H=>(triggerSubscriptions(O,H),H)).catch(H=>(triggerSubscriptions(V,H),Promise.reject(H))):(triggerSubscriptions(O,L),L)}}const A={_p:o,$id:e,$onAction:addSubscription.bind(null,b),$patch:y,$reset:v,$subscribe(x,T={}){const I=addSubscription(f,x,T.detached,()=>O()),O=a.run(()=>watch(()=>o.state.value[e],V=>{(T.flush==="sync"?u:d)&&x({storeId:e,type:MutationType.direct,events:C},V)},assign({},l,T)));return I},$dispose:k},$=reactive(A);o._s.set(e,$);const M=o._e.run(()=>(a=effectScope(),a.run(()=>n())));for(const x in M){const T=M[x];if(isRef(T)&&!isComputed(T)||isReactive(T))i||(g&&shouldHydrate(T)&&(isRef(T)?T.value=g[x]:mergeReactiveObjects(T,g[x])),o.state.value[e][x]=T);else if(typeof T=="function"){const I=_(x,T);M[x]=I,s.actions[x]=T}}return assign($,M),assign(toRaw($),M),Object.defineProperty($,"$state",{get:()=>o.state.value[e],set:x=>{y(T=>{assign(T,x)})}}),o._p.forEach(x=>{assign($,a.run(()=>x({store:$,app:o._a,pinia:o,options:s})))}),g&&i&&t.hydrate&&t.hydrate($.$state,g),d=!0,u=!0,$}function defineStore(e,n,t){let o,r;const i=typeof n=="function";typeof e=="string"?(o=e,r=i?t:n):(r=e,o=e.id);function a(s,l){const d=getCurrentInstance();return s=s||d&&inject(piniaSymbol,null),s&&setActivePinia(s),s=activePinia,s._s.has(o)||(i?createSetupStore(o,n,r,s):createOptionsStore(o,r,s)),s._s.get(o)}return a.$id=o,a}const useAppStore=defineStore("app",{state:()=>({theme:useOsTheme().value}),getters:{themeRef(e){return e.theme==="light"?null:darkTheme}},actions:{switchTheme(){this.theme=this.theme==="light"?"dark":"light"}},persist:{enabled:!0}}),_hoisted_1$5={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},_hoisted_2$5=createBaseVNode("path",{opacity:".3",d:"M8 7h11v14H8z",fill:"currentColor"},null,-1),_hoisted_3$5=createBaseVNode("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z",fill:"currentColor"},null,-1),_hoisted_4$2=[_hoisted_2$5,_hoisted_3$5],ContentCopyTwotone=defineComponent({name:"ContentCopyTwotone",render:function(n,t){return openBlock(),createElementBlock("svg",_hoisted_1$5,_hoisted_4$2)}}),_hoisted_1$4={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},_hoisted_2$4=createBaseVNode("path",{opacity:".3",d:"M5.08 8h2.95c.32-1.25.78-2.45 1.38-3.56c-1.84.63-3.37 1.9-4.33 3.56zm2.42 4c0-.68.06-1.34.14-2H4.26c-.16.64-.26 1.31-.26 2s.1 1.36.26 2h3.38c-.08-.66-.14-1.32-.14-2zm-2.42 4a7.987 7.987 0 0 0 4.33 3.56A15.65 15.65 0 0 1 8.03 16H5.08zM12 4.04c-.83 1.2-1.48 2.53-1.91 3.96h3.82c-.43-1.43-1.08-2.76-1.91-3.96zM18.92 8a8.03 8.03 0 0 0-4.33-3.56c.6 1.11 1.06 2.31 1.38 3.56h2.95zM12 19.96c.83-1.2 1.48-2.53 1.91-3.96h-3.82c.43 1.43 1.08 2.76 1.91 3.96zm2.59-.4A8.03 8.03 0 0 0 18.92 16h-2.95a15.65 15.65 0 0 1-1.38 3.56zM19.74 10h-3.38c.08.66.14 1.32.14 2s-.06 1.34-.14 2h3.38c.16-.64.26-1.31.26-2s-.1-1.36-.26-2zM9.66 10c-.09.65-.16 1.32-.16 2s.07 1.34.16 2h4.68c.09-.66.16-1.32.16-2s-.07-1.35-.16-2H9.66z",fill:"currentColor"},null,-1),_hoisted_3$4=createBaseVNode("path",{d:"M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm6.93 6h-2.95a15.65 15.65 0 0 0-1.38-3.56A8.03 8.03 0 0 1 18.92 8zM12 4.04c.83 1.2 1.48 2.53 1.91 3.96h-3.82c.43-1.43 1.08-2.76 1.91-3.96zM4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2s.06 1.34.14 2H4.26zm.82 2h2.95c.32 1.25.78 2.45 1.38 3.56A7.987 7.987 0 0 1 5.08 16zm2.95-8H5.08a7.987 7.987 0 0 1 4.33-3.56A15.65 15.65 0 0 0 8.03 8zM12 19.96c-.83-1.2-1.48-2.53-1.91-3.96h3.82c-.43 1.43-1.08 2.76-1.91 3.96zM14.34 14H9.66c-.09-.66-.16-1.32-.16-2s.07-1.35.16-2h4.68c.09.65.16 1.32.16 2s-.07 1.34-.16 2zm.25 5.56c.6-1.11 1.06-2.31 1.38-3.56h2.95a8.03 8.03 0 0 1-4.33 3.56zM16.36 14c.08-.66.14-1.32.14-2s-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38z",fill:"currentColor"},null,-1),_hoisted_4$1=[_hoisted_2$4,_hoisted_3$4],LanguageTwotone=defineComponent({name:"LanguageTwotone",render:function(n,t){return openBlock(),createElementBlock("svg",_hoisted_1$4,_hoisted_4$1)}}),_hoisted_1$3={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},_hoisted_2$3=createBaseVNode("circle",{cx:"18",cy:"5",opacity:".3",r:"1",fill:"currentColor"},null,-1),_hoisted_3$3=createBaseVNode("circle",{cx:"6",cy:"12",opacity:".3",r:"1",fill:"currentColor"},null,-1),_hoisted_4=createBaseVNode("circle",{cx:"18",cy:"19.02",opacity:".3",r:"1",fill:"currentColor"},null,-1),_hoisted_5=createBaseVNode("path",{d:"M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81c1.66 0 3-1.34 3-3s-1.34-3-3-3s-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65c0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92c0-1.61-1.31-2.92-2.92-2.92zM18 4c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1zM6 13c-.55 0-1-.45-1-1s.45-1 1-1s1 .45 1 1s-.45 1-1 1zm12 7.02c-.55 0-1-.45-1-1s.45-1 1-1s1 .45 1 1s-.45 1-1 1z",fill:"currentColor"},null,-1),_hoisted_6=[_hoisted_2$3,_hoisted_3$3,_hoisted_4,_hoisted_5],ShareTwotone=defineComponent({name:"ShareTwotone",render:function(n,t){return openBlock(),createElementBlock("svg",_hoisted_1$3,_hoisted_6)}}),_hoisted_1$2={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},_hoisted_2$2=createBaseVNode("path",{d:"M12 3h.393a7.5 7.5 0 0 0 7.92 12.446A9 9 0 1 1 12 2.992z",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),_hoisted_3$2=[_hoisted_2$2],Moon=defineComponent({name:"Moon",render:function(n,t){return openBlock(),createElementBlock("svg",_hoisted_1$2,_hoisted_3$2)}}),_hoisted_1$1={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},_hoisted_2$1=createBaseVNode("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[createBaseVNode("circle",{cx:"12",cy:"12",r:"4"}),createBaseVNode("path",{d:"M3 12h1m8-9v1m8 8h1m-9 8v1M5.6 5.6l.7.7m12.1-.7l-.7.7m0 11.4l.7.7m-12.1-.7l-.7.7"})],-1),_hoisted_3$1=[_hoisted_2$1],Sun=defineComponent({name:"Sun",render:function(n,t){return openBlock(),createElementBlock("svg",_hoisted_1$1,_hoisted_3$1)}}),_hoisted_1={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 32 32"},_hoisted_2=createBaseVNode("path",{d:"M16 2a14 14 0 1 0 14 14A14.016 14.016 0 0 0 16 2zM4.02 16.394l1.338.446L7 19.303v1.283a1 1 0 0 0 .293.707L10 24v2.377a11.994 11.994 0 0 1-5.98-9.983zM16 28a11.968 11.968 0 0 1-2.572-.285L14 26l1.805-4.512a1 1 0 0 0-.097-.926l-1.411-2.117a1 1 0 0 0-.832-.445h-4.93l-1.248-1.873L9.414 14H11v2h2v-2.734l3.868-6.77l-1.736-.992L14.277 7h-2.742L10.45 5.371A11.861 11.861 0 0 1 20 4.7V8a1 1 0 0 0 1 1h1.465a1 1 0 0 0 .832-.445l.877-1.316A12.033 12.033 0 0 1 26.894 11H22.82a1 1 0 0 0-.98.804l-.723 4.47a1 1 0 0 0 .54 1.055L25 19l.685 4.056A11.98 11.98 0 0 1 16 28z",fill:"currentColor"},null,-1),_hoisted_3=[_hoisted_2],EarthFilled=defineComponent({name:"EarthFilled",render:function(n,t){return openBlock(),createElementBlock("svg",_hoisted_1,_hoisted_3)}});var _a;const isClient=typeof window<"u",isString=e=>typeof e=="string",noop=()=>{};isClient&&((_a=window==null?void 0:window.navigator)!=null&&_a.userAgent)&&/iP(ad|hone|od)/.test(window.navigator.userAgent);function resolveUnref(e){return typeof e=="function"?e():unref(e)}function identity(e){return e}function tryOnScopeDispose(e){return getCurrentScope()?(onScopeDispose(e),!0):!1}function tryOnMounted(e,n=!0){getCurrentInstance()?onMounted(e):n?e():nextTick(e)}function useTimeoutFn(e,n,t={}){const{immediate:o=!0}=t,r=ref(!1);let i=null;function a(){i&&(clearTimeout(i),i=null)}function s(){r.value=!1,a()}function l(...d){a(),r.value=!0,i=setTimeout(()=>{r.value=!1,i=null,e(...d)},resolveUnref(n))}return o&&(r.value=!0,isClient&&l()),tryOnScopeDispose(s),{isPending:readonly(r),start:l,stop:s}}function unrefElement(e){var n;const t=resolveUnref(e);return(n=t==null?void 0:t.$el)!=null?n:t}const defaultWindow=isClient?window:void 0,defaultNavigator=isClient?window.navigator:void 0;function useEventListener(...e){let n,t,o,r;if(isString(e[0])||Array.isArray(e[0])?([t,o,r]=e,n=defaultWindow):[n,t,o,r]=e,!n)return noop;Array.isArray(t)||(t=[t]),Array.isArray(o)||(o=[o]);const i=[],a=()=>{i.forEach(u=>u()),i.length=0},s=(u,f,b,C)=>(u.addEventListener(f,b,C),()=>u.removeEventListener(f,b,C)),l=watch(()=>[unrefElement(n),resolveUnref(r)],([u,f])=>{a(),u&&i.push(...t.flatMap(b=>o.map(C=>s(u,b,C,f))))},{immediate:!0,flush:"post"}),d=()=>{l(),a()};return tryOnScopeDispose(d),d}function useSupported(e,n=!1){const t=ref(),o=()=>t.value=Boolean(e());return o(),tryOnMounted(o,n),t}function useClipboard(e={}){const{navigator:n=defaultNavigator,read:t=!1,source:o,copiedDuring:r=1500,legacy:i=!1}=e,a=["copy","cut"],s=useSupported(()=>n&&"clipboard"in n),l=computed(()=>s.value||i),d=ref(""),u=ref(!1),f=useTimeoutFn(()=>u.value=!1,r);function b(){s.value?n.clipboard.readText().then(y=>{d.value=y}):d.value=w()}if(l.value&&t)for(const y of a)useEventListener(y,b);async function C(y=resolveUnref(o)){l.value&&y!=null&&(s.value?await n.clipboard.writeText(y):g(y),d.value=y,u.value=!0,f.start())}function g(y){const v=document.createElement("textarea");v.value=y??"",v.style.position="absolute",v.style.opacity="0",document.body.appendChild(v),v.select(),document.execCommand("copy"),v.remove()}function w(){var y,v,k;return(k=(v=(y=document==null?void 0:document.getSelection)==null?void 0:y.call(document))==null?void 0:v.toString())!=null?k:""}return{isSupported:l,text:d,copied:u,copy:C}}const _global=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},globalKey="__vueuse_ssr_handlers__";_global[globalKey]=_global[globalKey]||{};_global[globalKey];var SwipeDirection;(function(e){e.UP="UP",e.RIGHT="RIGHT",e.DOWN="DOWN",e.LEFT="LEFT",e.NONE="NONE"})(SwipeDirection||(SwipeDirection={}));var __defProp=Object.defineProperty,__getOwnPropSymbols=Object.getOwnPropertySymbols,__hasOwnProp=Object.prototype.hasOwnProperty,__propIsEnum=Object.prototype.propertyIsEnumerable,__defNormalProp=(e,n,t)=>n in e?__defProp(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t,__spreadValues=(e,n)=>{for(var t in n||(n={}))__hasOwnProp.call(n,t)&&__defNormalProp(e,t,n[t]);if(__getOwnPropSymbols)for(var t of __getOwnPropSymbols(n))__propIsEnum.call(n,t)&&__defNormalProp(e,t,n[t]);return e};const _TransitionPresets={easeInSine:[.12,0,.39,0],easeOutSine:[.61,1,.88,1],easeInOutSine:[.37,0,.63,1],easeInQuad:[.11,0,.5,0],easeOutQuad:[.5,1,.89,1],easeInOutQuad:[.45,0,.55,1],easeInCubic:[.32,0,.67,0],easeOutCubic:[.33,1,.68,1],easeInOutCubic:[.65,0,.35,1],easeInQuart:[.5,0,.75,0],easeOutQuart:[.25,1,.5,1],easeInOutQuart:[.76,0,.24,1],easeInQuint:[.64,0,.78,0],easeOutQuint:[.22,1,.36,1],easeInOutQuint:[.83,0,.17,1],easeInExpo:[.7,0,.84,0],easeOutExpo:[.16,1,.3,1],easeInOutExpo:[.87,0,.13,1],easeInCirc:[.55,0,1,.45],easeOutCirc:[0,.55,.45,1],easeInOutCirc:[.85,0,.15,1],easeInBack:[.36,0,.66,-.56],easeOutBack:[.34,1.56,.64,1],easeInOutBack:[.68,-.6,.32,1.6]};__spreadValues({linear:identity},_TransitionPresets);function useWindowSize(e={}){const{window:n=defaultWindow,initialWidth:t=1/0,initialHeight:o=1/0,listenOrientation:r=!0,includeScrollbar:i=!0}=e,a=ref(t),s=ref(o),l=()=>{n&&(i?(a.value=n.innerWidth,s.value=n.innerHeight):(a.value=n.document.documentElement.clientWidth,s.value=n.document.documentElement.clientHeight))};return l(),tryOnMounted(l),useEventListener("resize",l,{passive:!0}),r&&useEventListener("orientationchange",l,{passive:!0}),{width:a,height:s}}const languages=["zh","en","ja"],isMobile=computed(()=>{const{width:e}=useWindowSize();return e.value<640}),categoryColors={help:"#fdba74",org:"#fbb741",game:"#14a3c7",term:"#ff7f7f",setup:"#94a3b8",pattern:"#bfdfa5",command:"#0284c7",english:"#2563eb",name:"#7a5299"};var luaparseExports={},luaparse={get exports(){return luaparseExports},set exports(e){luaparseExports=e}};(function(e,n){(function(t,o,r){var i=n&&!n.nodeType&&n,a=e&&!e.nodeType&&e,s=i&&a&&typeof commonjsGlobal=="object"&&commonjsGlobal,l=a&&a.exports===i&&i;s&&(s.global===s||s.window===s||s.self===s)&&(t=s),r(i&&a?l?a.exports:i:t[o]={})})(commonjsGlobal,"luaparse",function(t){t.version="0.3.1";var o,r,i,a,s,l=t.defaultOptions={wait:!1,comments:!0,scope:!1,locations:!1,ranges:!1,onCreateNode:null,onCreateScope:null,onDestroyScope:null,onLocalDeclaration:null,luaVersion:"5.1",encodingMode:"none"};function d(m,S){return S=S||0,m<128?String.fromCharCode(m):m<2048?String.fromCharCode(S|192|m>>6,S|128|m&63):m<65536?String.fromCharCode(S|224|m>>12,S|128|m>>6&63,S|128|m&63):m<1114112?String.fromCharCode(S|240|m>>18,S|128|m>>12&63,S|128|m>>6&63,S|128|m&63):null}function u(m,S){for(var B=m.toString(16);B.length<S;)B="0"+B;return B}function f(m){return function(S){var B=m.exec(S);if(!B)return S;H(null,M.invalidCodeUnit,u(B[0].charCodeAt(0),4).toUpperCase())}}var b={"pseudo-latin1":{fixup:f(/[^\x00-\xff]/),encodeByte:function(m){return m===null?"":String.fromCharCode(m)},encodeUTF8:function(m){return d(m)}},"x-user-defined":{fixup:f(/[^\x00-\x7f\uf780-\uf7ff]/),encodeByte:function(m){return m===null?"":m>=128?String.fromCharCode(m|63232):String.fromCharCode(m)},encodeUTF8:function(m){return d(m,63232)}},none:{discardStrings:!0,fixup:function(m){return m},encodeByte:function(m){return""},encodeUTF8:function(m){return""}}},C=1,g=2,w=4,y=8,v=16,k=32,_=64,A=128,$=256;t.tokenTypes={EOF:C,StringLiteral:g,Keyword:w,Identifier:y,NumericLiteral:v,Punctuator:k,BooleanLiteral:_,NilLiteral:A,VarargLiteral:$};var M=t.errors={unexpected:"unexpected %1 '%2' near '%3'",unexpectedEOF:"unexpected symbol near '<eof>'",expected:"'%1' expected near '%2'",expectedToken:"%1 expected near '%2'",unfinishedString:"unfinished string near '%1'",malformedNumber:"malformed number near '%1'",decimalEscapeTooLarge:"decimal escape too large near '%1'",invalidEscape:"invalid escape sequence near '%1'",hexadecimalDigitExpected:"hexadecimal digit expected near '%1'",braceExpected:"missing '%1' near '%2'",tooLargeCodepoint:"UTF-8 value too large near '%1'",unfinishedLongString:"unfinished long string (starting at line %1) near '%2'",unfinishedLongComment:"unfinished long comment (starting at line %1) near '%2'",ambiguousSyntax:"ambiguous syntax (function call x new statement) near '%1'",noLoopToBreak:"no loop to break near '%1'",labelAlreadyDefined:"label '%1' already defined on line %2",labelNotVisible:"no visible label '%1' for <goto>",gotoJumpInLocalScope:"<goto %1> jumps into the scope of local '%2'",cannotUseVararg:"cannot use '...' outside a vararg function near '%1'",invalidCodeUnit:"code unit U+%1 is not allowed in the current encoding mode"},x=t.ast={labelStatement:function(m){return{type:"LabelStatement",label:m}},breakStatement:function(){return{type:"BreakStatement"}},gotoStatement:function(m){return{type:"GotoStatement",label:m}},returnStatement:function(m){return{type:"ReturnStatement",arguments:m}},ifStatement:function(m){return{type:"IfStatement",clauses:m}},ifClause:function(m,S){return{type:"IfClause",condition:m,body:S}},elseifClause:function(m,S){return{type:"ElseifClause",condition:m,body:S}},elseClause:function(m){return{type:"ElseClause",body:m}},whileStatement:function(m,S){return{type:"WhileStatement",condition:m,body:S}},doStatement:function(m){return{type:"DoStatement",body:m}},repeatStatement:function(m,S){return{type:"RepeatStatement",condition:m,body:S}},localStatement:function(m,S){return{type:"LocalStatement",variables:m,init:S}},assignmentStatement:function(m,S){return{type:"AssignmentStatement",variables:m,init:S}},callStatement:function(m){return{type:"CallStatement",expression:m}},functionStatement:function(m,S,B,N){return{type:"FunctionDeclaration",identifier:m,isLocal:B,parameters:S,body:N}},forNumericStatement:function(m,S,B,N,re){return{type:"ForNumericStatement",variable:m,start:S,end:B,step:N,body:re}},forGenericStatement:function(m,S,B){return{type:"ForGenericStatement",variables:m,iterators:S,body:B}},chunk:function(m){return{type:"Chunk",body:m}},identifier:function(m){return{type:"Identifier",name:m}},literal:function(m,S,B){return m=m===g?"StringLiteral":m===v?"NumericLiteral":m===_?"BooleanLiteral":m===A?"NilLiteral":"VarargLiteral",{type:m,value:S,raw:B}},tableKey:function(m,S){return{type:"TableKey",key:m,value:S}},tableKeyString:function(m,S){return{type:"TableKeyString",key:m,value:S}},tableValue:function(m){return{type:"TableValue",value:m}},tableConstructorExpression:function(m){return{type:"TableConstructorExpression",fields:m}},binaryExpression:function(m,S,B){var N=m==="and"||m==="or"?"LogicalExpression":"BinaryExpression";return{type:N,operator:m,left:S,right:B}},unaryExpression:function(m,S){return{type:"UnaryExpression",operator:m,argument:S}},memberExpression:function(m,S,B){return{type:"MemberExpression",indexer:S,identifier:B,base:m}},indexExpression:function(m,S){return{type:"IndexExpression",base:m,index:S}},callExpression:function(m,S){return{type:"CallExpression",base:m,arguments:S}},tableCallExpression:function(m,S){return{type:"TableCallExpression",base:m,arguments:S}},stringCallExpression:function(m,S){return{type:"StringCallExpression",base:m,argument:S}},comment:function(m,S){return{type:"Comment",value:m,raw:S}}};function T(m){if(Me){var S=Ie.pop();S.complete(),S.bless(m)}return r.onCreateNode&&r.onCreateNode(m),m}var I=Array.prototype.slice,O=function(m,S){for(var B=0,N=m.length;B<N;++B)if(m[B]===S)return B;return-1};Array.prototype.indexOf&&(O=function(m,S){return m.indexOf(S)});function V(m,S,B){for(var N=0,re=m.length;N<re;++N)if(m[N][S]===B)return N;return-1}function z(m){var S=I.call(arguments,1);return m=m.replace(/%(\d)/g,function(B,N){return""+S[N-1]||""}),m}var Y=function(m){for(var S=I.call(arguments,1),B,N,re=0,xe=S.length;re<xe;++re){B=S[re];for(N in B)Object.prototype.hasOwnProperty.call(B,N)&&(m[N]=B[N])}return m};Object.assign&&(Y=Object.assign),t.SyntaxError=SyntaxError;function L(m){return Object.create?Object.create(m,{line:{writable:!0,value:m.line},index:{writable:!0,value:m.index},column:{writable:!0,value:m.column}}):m}function H(m){var S=z.apply(null,I.call(arguments,1)),B,N;throw m===null||typeof m.line>"u"?(N=R-de+1,B=L(new SyntaxError(z("[%1:%2] %3",ye,N,S))),B.index=R,B.line=ye,B.column=N):(N=m.range[0]-m.lineStart,B=L(new SyntaxError(z("[%1:%2] %3",m.line,N,S))),B.line=m.line,B.index=m.range[0],B.column=N),B}function te(m){var S=o.slice(m.range[0],m.range[1]);return S||m.value}function j(m,S){H(S,M.expectedToken,m,te(S))}function ee(m){var S=te(me);if(typeof m.type<"u"){var B;switch(m.type){case g:B="string";break;case w:B="keyword";break;case y:B="identifier";break;case v:B="number";break;case k:B="symbol";break;case _:B="boolean";break;case A:return H(m,M.unexpected,"symbol","nil",S);case C:return H(m,M.unexpectedEOF)}return H(m,M.unexpected,B,te(m),S)}return H(m,M.unexpected,"symbol",m,S)}var R,G,pe,me,Le,Ce,ye,de;t.lex=ge;function ge(){for(he();o.charCodeAt(R)===45&&o.charCodeAt(R+1)===45;)ce(),he();if(R>=i)return{type:C,value:"<eof>",line:ye,lineStart:de,range:[R,R]};var m=o.charCodeAt(R),S=o.charCodeAt(R+1);if(Ce=R,Ge(m))return Ke();switch(m){case 39:case 34:return E();case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:return K();case 46:return Te(S)?K():S===46?o.charCodeAt(R+2)===46?P():Pe(".."):Pe(".");case 61:return Pe(S===61?"==":"=");case 62:return a.bitwiseOperators&&S===62?Pe(">>"):Pe(S===61?">=":">");case 60:return a.bitwiseOperators&&S===60?Pe("<<"):Pe(S===61?"<=":"<");case 126:if(S===61)return Pe("~=");if(!a.bitwiseOperators)break;return Pe("~");case 58:return a.labels&&S===58?Pe("::"):Pe(":");case 91:return S===91||S===61?F():Pe("[");case 47:return a.integerDivision&&S===47?Pe("//"):Pe("/");case 38:case 124:if(!a.bitwiseOperators)break;case 42:case 94:case 37:case 44:case 123:case 125:case 93:case 40:case 41:case 59:case 35:case 45:case 43:return Pe(o.charAt(R))}return ee(o.charAt(R))}function Ve(){var m=o.charCodeAt(R),S=o.charCodeAt(R+1);return be(m)?(m===10&&S===13&&++R,m===13&&S===10&&++R,++ye,de=++R,!0):!1}function he(){for(;R<i;){var m=o.charCodeAt(R);if(Se(m))++R;else if(!Ve())break}}function Ke(){for(var m,S;Qe(o.charCodeAt(++R)););return m=s.fixup(o.slice(Ce,R)),Je(m)?S=w:m==="true"||m==="false"?(S=_,m=m==="true"):m==="nil"?(S=A,m=null):S=y,{type:S,value:m,line:ye,lineStart:de,range:[Ce,R]}}function Pe(m){return R+=m.length,{type:k,value:m,line:ye,lineStart:de,range:[Ce,R]}}function P(){return R+=3,{type:$,value:"...",line:ye,lineStart:de,range:[Ce,R]}}function E(){for(var m=o.charCodeAt(R++),S=ye,B=de,N=R,re=s.discardStrings?null:"",xe;xe=o.charCodeAt(R++),m!==xe;)if((R>i||be(xe))&&(re+=o.slice(N,R-1),H(null,M.unfinishedString,o.slice(Ce,R-1))),xe===92){if(!s.discardStrings){var $e=o.slice(N,R-1);re+=s.fixup($e)}var Oe=W();s.discardStrings||(re+=Oe),N=R}return s.discardStrings||(re+=s.encodeByte(null),re+=s.fixup(o.slice(N,R-1))),{type:g,value:re,line:S,lineStart:B,lastLine:ye,lastLineStart:de,range:[Ce,R]}}function F(){var m=ye,S=de,B=se(!1);return B===!1&&H(G,M.expected,"[",te(G)),{type:g,value:s.discardStrings?null:s.fixup(B),line:m,lineStart:S,lastLine:ye,lastLineStart:de,range:[Ce,R]}}function K(){var m=o.charAt(R),S=o.charAt(R+1),B=m==="0"&&"xX".indexOf(S||null)>=0?oe():Q(),N=q(),re=ne();return re&&(N||B.hasFractionPart)&&H(null,M.malformedNumber,o.slice(Ce,R)),{type:v,value:B.value,line:ye,lineStart:de,range:[Ce,R]}}function q(){if(a.imaginaryNumbers)return"iI".indexOf(o.charAt(R)||null)>=0?(++R,!0):!1}function ne(){if(a.integerSuffixes){if("uU".indexOf(o.charAt(R)||null)>=0)if(++R,"lL".indexOf(o.charAt(R)||null)>=0){if(++R,"lL".indexOf(o.charAt(R)||null)>=0)return++R,"ULL";H(null,M.malformedNumber,o.slice(Ce,R))}else H(null,M.malformedNumber,o.slice(Ce,R));else if("lL".indexOf(o.charAt(R)||null)>=0){if(++R,"lL".indexOf(o.charAt(R)||null)>=0)return++R,"LL";H(null,M.malformedNumber,o.slice(Ce,R))}}}function oe(){var m=0,S=1,B=1,N,re,xe,$e;for($e=R+=2,Ee(o.charCodeAt(R))||H(null,M.malformedNumber,o.slice(Ce,R));Ee(o.charCodeAt(R));)++R;N=parseInt(o.slice($e,R),16);var Oe=!1;if(o.charAt(R)==="."){for(Oe=!0,re=++R;Ee(o.charCodeAt(R));)++R;m=o.slice(re,R),m=re===R?0:parseInt(m,16)/Math.pow(16,R-re)}var sn=!1;if("pP".indexOf(o.charAt(R)||null)>=0){for(sn=!0,++R,"+-".indexOf(o.charAt(R)||null)>=0&&(B=o.charAt(R++)==="+"?1:-1),xe=R,Te(o.charCodeAt(R))||H(null,M.malformedNumber,o.slice(Ce,R));Te(o.charCodeAt(R));)++R;S=o.slice(xe,R),S=Math.pow(2,S*B)}return{value:(N+m)*S,hasFractionPart:Oe||sn}}function Q(){for(;Te(o.charCodeAt(R));)++R;var m=!1;if(o.charAt(R)===".")for(m=!0,++R;Te(o.charCodeAt(R));)++R;var S=!1;if("eE".indexOf(o.charAt(R)||null)>=0)for(S=!0,++R,"+-".indexOf(o.charAt(R)||null)>=0&&++R,Te(o.charCodeAt(R))||H(null,M.malformedNumber,o.slice(Ce,R));Te(o.charCodeAt(R));)++R;return{value:parseFloat(o.slice(Ce,R)),hasFractionPart:m||S}}function Z(){var m=R++;for(o.charAt(R++)!=="{"&&H(null,M.braceExpected,"{","\\"+o.slice(m,R)),Ee(o.charCodeAt(R))||H(null,M.hexadecimalDigitExpected,"\\"+o.slice(m,R));o.charCodeAt(R)===48;)++R;for(var S=R;Ee(o.charCodeAt(R));)++R,R-S>6&&H(null,M.tooLargeCodepoint,"\\"+o.slice(m,R));var B=o.charAt(R++);B!=="}"&&(B==='"'||B==="'"?H(null,M.braceExpected,"}","\\"+o.slice(m,R--)):H(null,M.hexadecimalDigitExpected,"\\"+o.slice(m,R)));var N=parseInt(o.slice(S,R-1)||"0",16),re="\\"+o.slice(m,R);return N>1114111&&H(null,M.tooLargeCodepoint,re),s.encodeUTF8(N,re)}function W(){var m=R;switch(o.charAt(R)){case"a":return++R,"\x07";case"n":return++R,`
`;case"r":return++R,"\r";case"t":return++R,"	";case"v":return++R,"\v";case"b":return++R,"\b";case"f":return++R,"\f";case"\r":case`
`:return Ve(),`
`;case"0":case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":for(;Te(o.charCodeAt(R))&&R-m<3;)++R;var S=o.slice(m,R),B=parseInt(S,10);return B>255&&H(null,M.decimalEscapeTooLarge,"\\"+B),s.encodeByte(B,"\\"+S);case"z":if(a.skipWhitespaceEscape)return++R,he(),"";break;case"x":if(a.hexEscapes){if(Ee(o.charCodeAt(R+1))&&Ee(o.charCodeAt(R+2)))return R+=3,s.encodeByte(parseInt(o.slice(m+1,R),16),"\\"+o.slice(m,R));H(null,M.hexadecimalDigitExpected,"\\"+o.slice(m,R+2))}break;case"u":if(a.unicodeEscapes)return Z();break;case"\\":case'"':case"'":return o.charAt(R++)}return a.strictEscapes&&H(null,M.invalidEscape,"\\"+o.slice(m,R+1)),o.charAt(R++)}function ce(){Ce=R,R+=2;var m=o.charAt(R),S="",B=!1,N=R,re=de,xe=ye;if(m==="["&&(S=se(!0),S===!1?S=m:B=!0),!B){for(;R<i&&!be(o.charCodeAt(R));)++R;r.comments&&(S=o.slice(N,R))}if(r.comments){var $e=x.comment(S,o.slice(Ce,R));r.locations&&($e.loc={start:{line:xe,column:Ce-re},end:{line:ye,column:R-de}}),r.ranges&&($e.range=[Ce,R]),r.onCreateNode&&r.onCreateNode($e),Le.push($e)}}function se(m){var S=0,B="",N=!1,re,xe,$e=ye;for(++R;o.charAt(R+S)==="=";)++S;if(o.charAt(R+S)!=="[")return!1;for(R+=S+1,be(o.charCodeAt(R))&&Ve(),xe=R;R<i;){for(;be(o.charCodeAt(R));)Ve();if(re=o.charAt(R++),re==="]"){N=!0;for(var Oe=0;Oe<S;++Oe)o.charAt(R+Oe)!=="="&&(N=!1);o.charAt(R+S)!=="]"&&(N=!1)}if(N)return B+=o.slice(xe,R-1),R+=S+1,B}H(null,m?M.unfinishedLongComment:M.unfinishedLongString,$e,"<eof>")}function X(){pe=G,G=me,me=ge()}function ie(m){return m===G.value?(X(),!0):!1}function le(m){m===G.value?X():H(G,M.expected,m,te(G))}function Se(m){return m===9||m===32||m===11||m===12}function be(m){return m===10||m===13}function Te(m){return m>=48&&m<=57}function Ee(m){return m>=48&&m<=57||m>=97&&m<=102||m>=65&&m<=70}function Ge(m){return!!(m>=65&&m<=90||m>=97&&m<=122||m===95||a.extendedIdentifiers&&m>=128)}function Qe(m){return!!(m>=65&&m<=90||m>=97&&m<=122||m===95||m>=48&&m<=57||a.extendedIdentifiers&&m>=128)}function Je(m){switch(m.length){case 2:return m==="do"||m==="if"||m==="in"||m==="or";case 3:return m==="and"||m==="end"||m==="for"||m==="not";case 4:return m==="else"||m==="then"?!0:a.labels&&!a.contextualGoto?m==="goto":!1;case 5:return m==="break"||m==="local"||m==="until"||m==="while";case 6:return m==="elseif"||m==="repeat"||m==="return";case 8:return m==="function"}return!1}function qe(m){return k===m.type?"#-~".indexOf(m.value)>=0:w===m.type?m.value==="not":!1}function Be(m){if(C===m.type)return!0;if(w!==m.type)return!1;switch(m.value){case"else":case"elseif":case"end":case"until":return!0;default:return!1}}var J,ae,fe;function ve(){var m=J[ae++].slice();J.push(m),r.onCreateScope&&r.onCreateScope()}function ke(){J.pop(),--ae,r.onDestroyScope&&r.onDestroyScope()}function ze(m){r.onLocalDeclaration&&r.onLocalDeclaration(m),O(J[ae],m)===-1&&J[ae].push(m)}function He(m){ze(m.name),Ae(m,!0)}function Ae(m,S){!S&&V(fe,"name",m.name)===-1&&fe.push(m),m.isLocal=S}function je(m){return O(J[ae],m)!==-1}var Ie=[],Me;function Ue(){return new rn(G)}function rn(m){r.locations&&(this.loc={start:{line:m.line,column:m.range[0]-m.lineStart},end:{line:0,column:0}}),r.ranges&&(this.range=[m.range[0],0])}rn.prototype.complete=function(){r.locations&&(this.loc.end.line=pe.lastLine||pe.line,this.loc.end.column=pe.range[1]-(pe.lastLineStart||pe.lineStart)),r.ranges&&(this.range[1]=pe.range[1])},rn.prototype.bless=function(m){if(this.loc){var S=this.loc;m.loc={start:{line:S.start.line,column:S.start.column},end:{line:S.end.line,column:S.end.column}}}this.range&&(m.range=[this.range[0],this.range[1]])};function en(){Me&&Ie.push(Ue())}function Fe(m){Me&&Ie.push(m)}function We(){this.scopes=[],this.pendingGotos=[]}We.prototype.isInLoop=function(){for(var m=this.scopes.length;m-- >0;)if(this.scopes[m].isLoop)return!0;return!1},We.prototype.pushScope=function(m){var S={labels:{},locals:[],deferredGotos:[],isLoop:!!m};this.scopes.push(S)},We.prototype.popScope=function(){for(var m=0;m<this.pendingGotos.length;++m){var S=this.pendingGotos[m];S.maxDepth>=this.scopes.length&&--S.maxDepth<=0&&H(S.token,M.labelNotVisible,S.target)}this.scopes.pop()},We.prototype.addGoto=function(m,S){for(var B=[],N=0;N<this.scopes.length;++N){var re=this.scopes[N];if(B.push(re.locals.length),Object.prototype.hasOwnProperty.call(re.labels,m))return}this.pendingGotos.push({maxDepth:this.scopes.length,target:m,token:S,localCounts:B})},We.prototype.addLabel=function(m,S){var B=this.currentScope();if(Object.prototype.hasOwnProperty.call(B.labels,m))H(S,M.labelAlreadyDefined,m,B.labels[m].line);else{for(var N=[],re=0;re<this.pendingGotos.length;++re){var xe=this.pendingGotos[re];if(xe.maxDepth>=this.scopes.length&&xe.target===m){xe.localCounts[this.scopes.length-1]<B.locals.length&&B.deferredGotos.push(xe);continue}N.push(xe)}this.pendingGotos=N}B.labels[m]={localCount:B.locals.length,line:S.line}},We.prototype.addLocal=function(m,S){this.currentScope().locals.push({name:m,token:S})},We.prototype.currentScope=function(){return this.scopes[this.scopes.length-1]},We.prototype.raiseDeferredErrors=function(){for(var m=this.currentScope(),S=m.deferredGotos,B=0;B<S.length;++B){var N=S[B];H(N.token,M.gotoJumpInLocalScope,N.target,m.locals[N.localCounts[this.scopes.length-1]].name)}};function D(){this.level=0,this.loopLevels=[]}D.prototype.isInLoop=function(){return!!this.loopLevels.length},D.prototype.pushScope=function(m){++this.level,m&&this.loopLevels.push(this.level)},D.prototype.popScope=function(){var m=this.loopLevels,S=m.length;S&&m[S-1]===this.level&&m.pop(),--this.level},D.prototype.addGoto=D.prototype.addLabel=function(){throw new Error("This should never happen")},D.prototype.addLocal=D.prototype.raiseDeferredErrors=function(){};function U(){return a.labels?new We:new D}function ue(){X(),en(),r.scope&&ve();var m=U();m.allowVararg=!0,m.pushScope();var S=we(m);return m.popScope(),r.scope&&ke(),C!==G.type&&ee(G),Me&&!S.length&&(pe=G),T(x.chunk(S))}function we(m){for(var S=[],B;!Be(G);){if(G.value==="return"||!a.relaxedBreak&&G.value==="break"){S.push(De(m));break}B=De(m),ie(";"),B&&S.push(B)}return S}function De(m){if(en(),k===G.type&&ie("::"))return Re(m);if(a.emptyStatement&&ie(";")){Me&&Ie.pop();return}if(m.raiseDeferredErrors(),w===G.type)switch(G.value){case"local":return X(),Cn(m);case"if":return X(),vn(m);case"return":return X(),ln(m);case"function":X();var S=wn();return cn(S);case"while":return X(),nn(m);case"for":return X(),yn(m);case"repeat":return X(),tn(m);case"break":return X(),m.isInLoop()||H(G,M.noLoopToBreak,G.value),Ye();case"do":return X(),Xe(m);case"goto":return X(),Ze(m)}return a.contextualGoto&&G.type===y&&G.value==="goto"&&me.type===y&&me.value!=="goto"?(X(),Ze(m)):(Me&&Ie.pop(),xn(m))}function Re(m){var S=G,B=Ne();return r.scope&&(ze("::"+S.value+"::"),Ae(B,!0)),le("::"),m.addLabel(S.value,S),T(x.labelStatement(B))}function Ye(){return T(x.breakStatement())}function Ze(m){var S=G.value,B=pe,N=Ne();return m.addGoto(S,B),T(x.gotoStatement(N))}function Xe(m){r.scope&&ve(),m.pushScope();var S=we(m);return m.popScope(),r.scope&&ke(),le("end"),T(x.doStatement(S))}function nn(m){var S=_e(m);le("do"),r.scope&&ve(),m.pushScope(!0);var B=we(m);return m.popScope(),r.scope&&ke(),le("end"),T(x.whileStatement(S,B))}function tn(m){r.scope&&ve(),m.pushScope(!0);var S=we(m);le("until"),m.raiseDeferredErrors();var B=_e(m);return m.popScope(),r.scope&&ke(),T(x.repeatStatement(B,S))}function ln(m){var S=[];if(G.value!=="end"){var B=an(m);for(B!=null&&S.push(B);ie(",");)B=_e(m),S.push(B);ie(";")}return T(x.returnStatement(S))}function vn(m){var S=[],B,N,re;for(Me&&(re=Ie[Ie.length-1],Ie.push(re)),B=_e(m),le("then"),r.scope&&ve(),m.pushScope(),N=we(m),m.popScope(),r.scope&&ke(),S.push(T(x.ifClause(B,N))),Me&&(re=Ue());ie("elseif");)Fe(re),B=_e(m),le("then"),r.scope&&ve(),m.pushScope(),N=we(m),m.popScope(),r.scope&&ke(),S.push(T(x.elseifClause(B,N))),Me&&(re=Ue());return ie("else")&&(Me&&(re=new rn(pe),Ie.push(re)),r.scope&&ve(),m.pushScope(),N=we(m),m.popScope(),r.scope&&ke(),S.push(T(x.elseClause(N)))),le("end"),T(x.ifStatement(S))}function yn(m){var S=Ne(),B;if(r.scope&&(ve(),He(S)),ie("=")){var N=_e(m);le(",");var re=_e(m),xe=ie(",")?_e(m):null;return le("do"),m.pushScope(!0),B=we(m),m.popScope(),le("end"),r.scope&&ke(),T(x.forNumericStatement(S,N,re,xe,B))}else{for(var $e=[S];ie(",");)S=Ne(),r.scope&&He(S),$e.push(S);le("in");var Oe=[];do{var sn=_e(m);Oe.push(sn)}while(ie(","));return le("do"),m.pushScope(!0),B=we(m),m.popScope(),le("end"),r.scope&&ke(),T(x.forGenericStatement($e,Oe,B))}}function Cn(m){var S,B=pe;if(y===G.type){var N=[],re=[];do S=Ne(),N.push(S),m.addLocal(S.name,B);while(ie(","));if(ie("="))do{var xe=_e(m);re.push(xe)}while(ie(","));if(r.scope)for(var $e=0,Oe=N.length;$e<Oe;++$e)He(N[$e]);return T(x.localStatement(N,re))}if(ie("function"))return S=Ne(),m.addLocal(S.name,B),r.scope&&(He(S),ve()),cn(S,!0);j("<name>",G)}function xn(m){var S,B,N,re,xe,$e=[];Me&&(B=Ue());do{if(Me&&(S=Ue()),y===G.type)xe=G.value,re=Ne(),r.scope&&Ae(re,je(xe)),N=!0;else if(G.value==="(")X(),re=_e(m),le(")"),N=!1;else return ee(G);e:for(;;){switch(g===G.type?'"':G.value){case".":case"[":N=!0;break;case":":case"(":case"{":case'"':N=null;break;default:break e}re=hn(re,S,m)}if($e.push(re),G.value!==",")break;if(!N)return ee(G);X()}while(!0);if($e.length===1&&N===null)return Fe(S),T(x.callStatement($e[0]));if(!N)return ee(G);le("=");var Oe=[];do Oe.push(_e(m));while(ie(","));return Fe(B),T(x.assignmentStatement($e,Oe))}function Ne(){en();var m=G.value;return y!==G.type&&j("<name>",G),X(),T(x.identifier(m))}function cn(m,S){var B=U();B.pushScope();var N=[];if(le("("),!ie(")"))for(;;){if(y===G.type){var re=Ne();if(r.scope&&He(re),N.push(re),ie(","))continue}else $===G.type?(B.allowVararg=!0,N.push(fn(B))):j("<name> or '...'",G);le(")");break}var xe=we(B);return B.popScope(),le("end"),r.scope&&ke(),S=S||!1,T(x.functionStatement(m,N,S,xe))}function wn(){var m,S,B;for(Me&&(B=Ue()),m=Ne(),r.scope&&(Ae(m,je(m.name)),ve());ie(".");)Fe(B),S=Ne(),m=T(x.memberExpression(m,".",S));return ie(":")&&(Fe(B),S=Ne(),m=T(x.memberExpression(m,":",S)),r.scope&&ze("self")),m}function pn(m){for(var S=[],B,N;;){if(en(),k===G.type&&ie("["))B=_e(m),le("]"),le("="),N=_e(m),S.push(T(x.tableKey(B,N)));else if(y===G.type)me.value==="="?(B=Ne(),X(),N=_e(m),S.push(T(x.tableKeyString(B,N)))):(N=_e(m),S.push(T(x.tableValue(N))));else{if((N=an(m))==null){Ie.pop();break}S.push(T(x.tableValue(N)))}if(",;".indexOf(G.value)>=0){X();continue}break}return le("}"),T(x.tableConstructorExpression(S))}function an(m){var S=dn(0,m);return S}function _e(m){var S=an(m);if(S==null)j("<expression>",G);else return S}function Sn(m){var S=m.charCodeAt(0),B=m.length;if(B===1)switch(S){case 94:return 12;case 42:case 47:case 37:return 10;case 43:case 45:return 9;case 38:return 6;case 126:return 5;case 124:return 4;case 60:case 62:return 3}else if(B===2)switch(S){case 47:return 10;case 46:return 8;case 60:case 62:return m==="<<"||m===">>"?7:3;case 61:case 126:return 3;case 111:return 1}else if(S===97&&m==="and")return 2;return 0}function dn(m,S){var B=G.value,N,re;if(Me&&(re=Ue()),qe(G)){en(),X();var xe=dn(10,S);xe==null&&j("<expression>",G),N=T(x.unaryExpression(B,xe))}if(N==null&&(N=fn(S),N==null&&(N=Tn(S))),N==null)return null;for(var $e;B=G.value,$e=k===G.type||w===G.type?Sn(B):0,!($e===0||$e<=m);){(B==="^"||B==="..")&&--$e,X();var Oe=dn($e,S);Oe==null&&j("<expression>",G),Me&&Ie.push(re),N=T(x.binaryExpression(B,N,Oe))}return N}function hn(m,S,B){var N,re;if(k===G.type)switch(G.value){case"[":return Fe(S),X(),N=_e(B),le("]"),T(x.indexExpression(m,N));case".":return Fe(S),X(),re=Ne(),T(x.memberExpression(m,".",re));case":":return Fe(S),X(),re=Ne(),m=T(x.memberExpression(m,":",re)),Fe(S),un(m,B);case"(":case"{":return Fe(S),un(m,B)}else if(g===G.type)return Fe(S),un(m,B);return null}function Tn(m){var S,B,N;if(Me&&(N=Ue()),y===G.type)B=G.value,S=Ne(),r.scope&&Ae(S,je(B));else if(ie("("))S=_e(m),le(")");else return null;for(;;){var re=hn(S,N,m);if(re===null)break;S=re}return S}function un(m,S){if(k===G.type)switch(G.value){case"(":a.emptyStatement||G.line!==pe.line&&H(null,M.ambiguousSyntax,G.value),X();var B=[],N=an(S);for(N!=null&&B.push(N);ie(",");)N=_e(S),B.push(N);return le(")"),T(x.callExpression(m,B));case"{":en(),X();var re=pn(S);return T(x.tableCallExpression(m,re))}else if(g===G.type)return T(x.stringCallExpression(m,fn(S)));j("function arguments",G)}function fn(m){var S=g|v|_|A|$,B=G.value,N=G.type,re;if(Me&&(re=Ue()),N===$&&!m.allowVararg&&H(G,M.cannotUseVararg,G.value),N&S){Fe(re);var xe=o.slice(G.range[0],G.range[1]);return X(),T(x.literal(N,B,xe))}else{if(w===N&&B==="function")return Fe(re),X(),r.scope&&ve(),cn(null);if(ie("{"))return Fe(re),pn(m)}}t.parse=kn;var mn={"5.1":{},"5.2":{labels:!0,emptyStatement:!0,hexEscapes:!0,skipWhitespaceEscape:!0,strictEscapes:!0,relaxedBreak:!0},"5.3":{labels:!0,emptyStatement:!0,hexEscapes:!0,skipWhitespaceEscape:!0,strictEscapes:!0,unicodeEscapes:!0,bitwiseOperators:!0,integerDivision:!0,relaxedBreak:!0},LuaJIT:{labels:!0,contextualGoto:!0,hexEscapes:!0,skipWhitespaceEscape:!0,strictEscapes:!0,unicodeEscapes:!0,imaginaryNumbers:!0,integerSuffixes:!0}};function kn(m,S){if(typeof S>"u"&&typeof m=="object"&&(S=m,m=void 0),S||(S={}),o=m||"",r=Y({},l,S),R=0,ye=1,de=0,i=o.length,J=[[]],ae=0,fe=[],Ie=[],!Object.prototype.hasOwnProperty.call(mn,r.luaVersion))throw new Error(z("Lua version '%1' not supported",r.luaVersion));if(a=Y({},mn[r.luaVersion]),r.extendedIdentifiers!==void 0&&(a.extendedIdentifiers=!!r.extendedIdentifiers),!Object.prototype.hasOwnProperty.call(b,r.encodingMode))throw new Error(z("Encoding mode '%1' not supported",r.encodingMode));return s=b[r.encodingMode],r.comments&&(Le=[]),r.wait?t:bn()}t.write=gn;function gn(m){return o+=String(m),i=o.length,t}t.end=bn;function bn(m){typeof m<"u"&&gn(m),o&&o.substr(0,2)==="#!"&&(o=o.replace(/^.*/,function(B){return B.replace(/./g," ")})),i=o.length,Me=r.locations||r.ranges,me=ge();var S=ue();if(r.comments&&(S.comments=Le),r.scope&&(S.globals=fe),Ie.length>0)throw new Error("Location tracking failed. This is most likely a bug in luaparse");return S}})})(luaparse,luaparseExports);const version="3.7.5",VERSION=version,_hasatob=typeof atob=="function",_hasbtoa=typeof btoa=="function",_hasBuffer=typeof Buffer=="function",_TD=typeof TextDecoder=="function"?new TextDecoder:void 0,_TE=typeof TextEncoder=="function"?new TextEncoder:void 0,b64ch="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",b64chs=Array.prototype.slice.call(b64ch),b64tab=(e=>{let n={};return e.forEach((t,o)=>n[t]=o),n})(b64chs),b64re=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,_fromCC=String.fromCharCode.bind(String),_U8Afrom=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),_mkUriSafe=e=>e.replace(/=/g,"").replace(/[+\/]/g,n=>n=="+"?"-":"_"),_tidyB64=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),btoaPolyfill=e=>{let n,t,o,r,i="";const a=e.length%3;for(let s=0;s<e.length;){if((t=e.charCodeAt(s++))>255||(o=e.charCodeAt(s++))>255||(r=e.charCodeAt(s++))>255)throw new TypeError("invalid character found");n=t<<16|o<<8|r,i+=b64chs[n>>18&63]+b64chs[n>>12&63]+b64chs[n>>6&63]+b64chs[n&63]}return a?i.slice(0,a-3)+"===".substring(a):i},_btoa=_hasbtoa?e=>btoa(e):_hasBuffer?e=>Buffer.from(e,"binary").toString("base64"):btoaPolyfill,_fromUint8Array=_hasBuffer?e=>Buffer.from(e).toString("base64"):e=>{let t=[];for(let o=0,r=e.length;o<r;o+=4096)t.push(_fromCC.apply(null,e.subarray(o,o+4096)));return _btoa(t.join(""))},fromUint8Array=(e,n=!1)=>n?_mkUriSafe(_fromUint8Array(e)):_fromUint8Array(e),cb_utob=e=>{if(e.length<2){var n=e.charCodeAt(0);return n<128?e:n<2048?_fromCC(192|n>>>6)+_fromCC(128|n&63):_fromCC(224|n>>>12&15)+_fromCC(128|n>>>6&63)+_fromCC(128|n&63)}else{var n=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return _fromCC(240|n>>>18&7)+_fromCC(128|n>>>12&63)+_fromCC(128|n>>>6&63)+_fromCC(128|n&63)}},re_utob=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,utob=e=>e.replace(re_utob,cb_utob),_encode=_hasBuffer?e=>Buffer.from(e,"utf8").toString("base64"):_TE?e=>_fromUint8Array(_TE.encode(e)):e=>_btoa(utob(e)),encode=(e,n=!1)=>n?_mkUriSafe(_encode(e)):_encode(e),encodeURI=e=>encode(e,!0),re_btou=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,cb_btou=e=>{switch(e.length){case 4:var n=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),t=n-65536;return _fromCC((t>>>10)+55296)+_fromCC((t&1023)+56320);case 3:return _fromCC((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return _fromCC((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},btou=e=>e.replace(re_btou,cb_btou),atobPolyfill=e=>{if(e=e.replace(/\s+/g,""),!b64re.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let n,t="",o,r;for(let i=0;i<e.length;)n=b64tab[e.charAt(i++)]<<18|b64tab[e.charAt(i++)]<<12|(o=b64tab[e.charAt(i++)])<<6|(r=b64tab[e.charAt(i++)]),t+=o===64?_fromCC(n>>16&255):r===64?_fromCC(n>>16&255,n>>8&255):_fromCC(n>>16&255,n>>8&255,n&255);return t},_atob=_hasatob?e=>atob(_tidyB64(e)):_hasBuffer?e=>Buffer.from(e,"base64").toString("binary"):atobPolyfill,_toUint8Array=_hasBuffer?e=>_U8Afrom(Buffer.from(e,"base64")):e=>_U8Afrom(_atob(e).split("").map(n=>n.charCodeAt(0))),toUint8Array=e=>_toUint8Array(_unURI(e)),_decode=_hasBuffer?e=>Buffer.from(e,"base64").toString("utf8"):_TD?e=>_TD.decode(_toUint8Array(e)):e=>btou(_atob(e)),_unURI=e=>_tidyB64(e.replace(/[-_]/g,n=>n=="-"?"+":"/")),decode=e=>_decode(_unURI(e)),isValid=e=>{if(typeof e!="string")return!1;const n=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(n)||!/[^\s0-9a-zA-Z\-_]/.test(n)},_noEnum=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),extendString=function(){const e=(n,t)=>Object.defineProperty(String.prototype,n,_noEnum(t));e("fromBase64",function(){return decode(this)}),e("toBase64",function(n){return encode(this,n)}),e("toBase64URI",function(){return encode(this,!0)}),e("toBase64URL",function(){return encode(this,!0)}),e("toUint8Array",function(){return toUint8Array(this)})},extendUint8Array=function(){const e=(n,t)=>Object.defineProperty(Uint8Array.prototype,n,_noEnum(t));e("toBase64",function(n){return fromUint8Array(this,n)}),e("toBase64URI",function(){return fromUint8Array(this,!0)}),e("toBase64URL",function(){return fromUint8Array(this,!0)})},extendBuiltins=()=>{extendString(),extendUint8Array()},gBase64={version,VERSION,atob:_atob,atobPolyfill,btoa:_btoa,btoaPolyfill,fromBase64:decode,toBase64:encode,encode,encodeURI,encodeURL:encodeURI,utob,btou,decode,isValid,fromUint8Array,toUint8Array,extendString,extendUint8Array,extendBuiltins},api=reactive({$message:useMessage(),$dialog:useDialog(),$notification:useNotification(),$loadingBar:useLoadingBar()});class Dict{constructor(n,t,o,r,i){this.title=n,this.tags=t,this.category=o,this._content=r,this.link=i}static get resolve(){if(location.hash.length>1)try{const n=location.hash.slice(1),t=JSON.parse(gBase64.decode(n));if("language"in t&&"title"in t)return languages.includes(t.language)&&(currentLang.value=t.language),dicts.value.find(o=>decodeURIComponent(t.title)===o.title)}catch{api.$message.error(translations.value.error)}}get content(){var n,t;return(t=(n=this._content)==null?void 0:n.replaceAll("\\t","	"))==null?void 0:t.replaceAll("\\n",`
`)}renderTitle(){if(!this.title)return h(NText,null,()=>"?");const n=/^tetris/ig,t=this.title.match(n);if(!this.title||!t)return h(NText,{class:"text-current"},()=>this.title);const o=this.title.replace(n,"");return h(NEl,null,()=>[h(NPopover,null,{trigger:()=>h("i",{class:"zChan thinking not-italic text-xl mr-1"}),default:()=>t[0]}),h(NText,{class:"text-current"},()=>o)])}async share(){const n=this;await copy(new URL("",location.href)+"#"+gBase64.encode(JSON.stringify({language:currentLang.value,title:encodeURIComponent(n.title??"?")})))}async copy(){const n=this;await copy([n.title,"",n.content,"",`${translations.value.copy_from}: ${translations.value.title}`].join(`\r
`))}}class Parser{constructor(e){$n(this,"variables",{CHAR:{mino:(()=>{const e={};return["Z","S","J","L","T","O","I","Z5","S5","P","Q","F","E","T5","U","V","W","X","J5","L5","R","Y","N","H","I5","I3","C","I2","O1"].forEach(n=>{e[n]=`<i class="not-italic text-cyan-500 text-4xl mino ${n}"></i>`}),e})()},FNNS:/OS/i.test(navigator.userAgent)});$n(this,"_items",[]);this.code=e}get items(){const e=this;return this._items.pop(),this._items.map(n=>{var t;return new Dict(e.processRaw(n[0],!1),((t=e.processRaw(n[1],!1))==null?void 0:t.split(" "))??[],e.processRaw(n[2],!1),e.processRaw(n[3],!1),e.processRaw(n[4],!1))})}parse(){const e=this;luaparseExports.parse(this.code).body.forEach(n=>{e.processStatement(n)})}processRaw(e,n=!0){if(!e)return null;e.startsWith('"')&&(e=e.slice(1)),e.endsWith('"')&&(e=e.slice(0,-1));let t=preg_replace_callback(e,/\\(\d+)/g,o=>String.fromCharCode(parseInt(o[1])));return n&&(t[0]!=='"'&&(t='"'+t),t[t.length-1]!=='"'&&(t=t+'"')),t}processStatement(e){const n=this;switch(e.type){case"LocalStatement":e.variables.forEach(function({name:t},o){const r=e.init[o];n.variables[t]=n.processRaw(r.raw)});break;case"ReturnStatement":e.arguments.forEach(t=>{this.processExpression(t)});break;default:throw new Error(`Unknown statement: ${e.type}`)}}processVariable(e){if(!has(this.variables,e))return e;const n=get(this.variables,e);switch(typeof n){case"object":return e;case"function":return n();default:return n}}wrapTableOrProcessExpression(e){const n=this.processExpression(e,{rawAddQuote:!0});return e.type==="TableConstructorExpression"?`[${n}]`:n}processExpression(expression,options={}){const that=this,temp=[];switch(expression.type){case"TableConstructorExpression":return expression.fields.forEach(e=>{temp.push(that.processExpression(e.value))}),temp.length>0&&this._items.push(temp),temp;case"BinaryExpression":switch(expression.operator){case"..":temp.push(that.processExpression(expression.left,{rawAddQuote:!1})),temp.push(that.processExpression(expression.right,{rawAddQuote:!1}));break;default:throw new Error(`Unknown operator: ${expression.operator}`)}return temp.join("");case"MemberExpression":return temp.push(that.processExpression(expression.base,{forceReturnVariableName:!0})),temp.push(expression.indexer),temp.push(that.processExpression(expression.identifier,{forceReturnVariableName:!0})),this.processVariable(temp.flat().join(""));case"LogicalExpression":switch(temp.push(that.processExpression(expression.left)),expression.operator){case"and":temp.push("&&");break;case"or":temp.push("||");break;default:throw new Error("Unknown operator")}temp.push(...that.wrapTableOrProcessExpression(expression.right));let code=temp.join(" ");return eval("() => "+code)();case"Identifier":return!has(that.variables,expression.name)||options.forceReturnVariableName?expression.name:this.processVariable(expression.name);case"StringLiteral":return that.processRaw(expression.raw,options.rawAddQuote??!0);default:throw new Error(`Unknown expression: ${expression.type}`)}}}function preg_replace_callback(e,n,t){const o=e.matchAll(n);return Array.from(o).forEach(r=>{const i=t(r);e=e.replace(r[0],i)}),e}function parseDictCode(e){const n=new Parser(e);return n.parse(),n.items}async function copy(e){const{copy:n,isSupported:t}=useClipboard({source:e,legacy:!0});if(!t){api.$message.error(translations.value.error);return}await n(),api.$message.success(translations.value.copied)}const dict_code_zh=`-- Automatically generated by a Python script, from a markdown source file.
...
`,dict_code_en=`-- Automatically generated by a Python script, from a markdown source file.
-- The script can be found here: https://github.com/user670/techmino-dictionary-converter/blob/master/tool.py 
return {
    {"Translator Note 1",
        "",
...
`,dict_code_ja=`-- Automatically generated by a Python script, from a markdown source file.
-- The script can be found here: https://github.com/user670/techmino-dictionary-converter/blob/master/tool.py 
return {
    {"翻訳者からのメッセージ 1",
        "",
...
`,_code$2="zh",_name$2="中文",title$2="Techmino 在线词典",search$3="搜点什么",tags$2="标签",copy_from$2="复制于",error$2="出错了",copied$2="复制成功!",maker$2="制作者",transitions_zh={_code:_code$2,_name:_name$2,title:title$2,search:search$3,tags:tags$2,copy_from:copy_from$2,error:error$2,copied:copied$2,maker:maker$2},_code$1="en",_name$1="English",title$1="Techmino Online Dictionary",search$2="Search",tags$1="Tags",copy_from$1="Copy from",error$1="Error",copied$1="Copied!",maker$1="Made by",transitions_en={_code:_code$1,_name:_name$1,title:title$1,search:search$2,tags:tags$1,copy_from:copy_from$1,error:error$1,copied:copied$1,maker:maker$1},_code="ja",_name="日本語",title="テクミノ オンライン辞書",search$1="サーチ",tags="ラベル",copy_from="からコピー",error="エラー",copied="コピーしました!",maker="作られた",transitions_ja={_code,_name,title,search:search$1,tags,copy_from,error,copied,maker},_key="language",language=ref(localStorage.getItem(_key));function setLanguage(e){currentLang.value=e}const currentLang=computed({get(){return!language.value||!languages.includes(language.value)?"zh":language.value},set(e){localStorage.setItem(_key,e),language.value=e}}),items={zh:{dicts:parseDictCode(dict_code_zh),translations:transitions_zh},en:{dicts:parseDictCode(dict_code_en),translations:transitions_en},ja:{dicts:parseDictCode(dict_code_ja),translations:transitions_ja}},languageSelectOptions=computed(()=>Object.values(items).map(e=>({label:e.translations._name,key:e.translations._code,disabled:currentLang.value===e.translations._code}))),dicts=computed(()=>items[currentLang.value].dicts),translations=computed(()=>items[currentLang.value].translations),search=ref(),result=computed(()=>groupBy$1(dicts.value.filter(e=>{var t;if(!search.value)return!0;const n=search.value.toLowerCase();return[!!((t=e.title)!=null&&t.toLowerCase().match(n)),e.tags.map(o=>o.toLowerCase()).includes(n)].includes(!0)}),"category")),_sfc_main$1=defineComponent({__name:"ApiInjector",setup(e){return api.$message=useMessage(),api.$dialog=useDialog(),api.$notification=useNotification(),api.$loadingBar=useLoadingBar(),(n,t)=>null}}),_sfc_main=defineComponent({__name:"App",setup(e){const n=useAppStore(),t=ref(Dict.resolve);function o(r){search.value=r,t.value=void 0}return(r,i)=>{const a=NIcon,s=__unplugin_components_1,l=__unplugin_components_2,d=__unplugin_components_3,u=NH1,f=__unplugin_components_5,b=__unplugin_components_6,C=__unplugin_components_7,g=__unplugin_components_8,w=__unplugin_components_9,y=NH2,v=__unplugin_components_11,k=__unplugin_components_12,_=__unplugin_components_13,A=__unplugin_components_14,$=__unplugin_components_15,M=NDialogProvider,x=__unplugin_components_17,T=__unplugin_components_18;return openBlock(),createBlock(T,{theme:unref(n).themeRef,class:"h-full"},{default:withCtx(()=>[createVNode(x,null,{default:withCtx(()=>[createVNode(M,null,{default:withCtx(()=>[createVNode($,null,{default:withCtx(()=>[createVNode(A,null,{default:withCtx(()=>[createVNode(_sfc_main$1),createVNode(_,{class:"h-full","native-scrollbar":""},{default:withCtx(()=>[createVNode(v,{class:"pb-16 h-full mx-2","native-scrollbar":""},{default:withCtx(()=>[createVNode(d,{class:"mt-2",justify:"space-between"},{default:withCtx(()=>[createVNode(s,{onClick:unref(n).switchTheme},{icon:withCtx(()=>[createVNode(a,{component:unref(n).theme==="light"?unref(Moon):unref(Sun)},null,8,["component"])]),_:1},8,["onClick"]),createVNode(l,{options:unref(languageSelectOptions),animated:"",trigger:"click",onSelect:unref(setLanguage)},{default:withCtx(()=>[createVNode(s,null,{icon:withCtx(()=>[createVNode(a,{component:unref(LanguageTwotone)},null,8,["component"])]),_:1})]),_:1},8,["options","onSelect"])]),_:1}),createVNode(d,{class:"sm:w-1/3 mx-auto mt-20",vertical:""},{default:withCtx(()=>[createVNode(unref(NEl),{class:"text-center"},{default:withCtx(()=>[createVNode(u,null,{default:withCtx(()=>[createTextVNode(toDisplayString(unref(translations).title),1)]),_:1}),unref(t)?(openBlock(),createBlock(d,{key:1,justify:"center"},{default:withCtx(()=>[createVNode(s,{onClick:i[1]||(i[1]=I=>t.value=void 0)},{default:withCtx(()=>[createTextVNode("返回")]),_:1})]),_:1})):(openBlock(),createBlock(f,{key:0,value:unref(search),"onUpdate:value":i[0]||(i[0]=I=>isRef(search)?search.value=I:null),placeholder:unref(translations).search,clearable:""},null,8,["value","placeholder"]))]),_:1}),createVNode(b)]),_:1}),createVNode(d,{size:"large",vertical:""},{default:withCtx(()=>[unref(t)?(openBlock(),createBlock(unref(NEl),{key:1,class:"sm:w-1/3 mx-auto"},{default:withCtx(()=>[createVNode(d,{vertical:""},{default:withCtx(()=>[createVNode(y,null,{default:withCtx(()=>[(openBlock(),createBlock(resolveDynamicComponent(unref(t).renderTitle())))]),_:1}),createVNode(unref(NText),{class:"whitespace-pre-wrap",innerHTML:unref(t).content},null,8,["innerHTML"]),createVNode(d,{class:"mt-10 items-end",justify:"space-between"},{default:withCtx(()=>[createVNode(d,{size:"small"},{default:withCtx(()=>[createVNode(unref(NText),null,{default:withCtx(()=>[createTextVNode(toDisplayString(unref(translations).tags)+": ",1)]),_:1}),(openBlock(!0),createElementBlock(Fragment,null,renderList(unref(t).tags,I=>(openBlock(),createBlock(s,{text:"",type:"info",onClick:O=>o(I)},{default:withCtx(()=>[createTextVNode(toDisplayString(I),1)]),_:2},1032,["onClick"]))),256))]),_:1}),createVNode(d,null,{default:withCtx(()=>[unref(t).link?(openBlock(),createBlock(s,{key:0,href:unref(t).link,tag:"a"},{icon:withCtx(()=>[createVNode(a,{component:unref(EarthFilled)},null,8,["component"])]),_:1},8,["href"])):createCommentVNode("",!0),createVNode(s,{onClick:i[2]||(i[2]=I=>{var O;return(O=unref(t))==null?void 0:O.copy()})},{icon:withCtx(()=>[createVNode(a,{component:unref(ContentCopyTwotone)},null,8,["component"])]),_:1}),createVNode(s,{onClick:i[3]||(i[3]=I=>{var O;return(O=unref(t))==null?void 0:O.share()})},{icon:withCtx(()=>[createVNode(a,{component:unref(ShareTwotone)},null,8,["component"])]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})):(openBlock(),createBlock(d,{key:0,vertical:""},{default:withCtx(()=>[(openBlock(!0),createElementBlock(Fragment,null,renderList(unref(result),(I,O)=>(openBlock(),createBlock(d,{class:"text-center",vertical:""},{default:withCtx(()=>[createVNode(unref(NText),{style:normalizeStyle({color:unref(categoryColors)[O]}),class:"font-bold text-2xl",type:"info"},{default:withCtx(()=>[createTextVNode(toDisplayString(O),1)]),_:2},1032,["style"]),unref(isMobile)?(openBlock(),createBlock(w,{key:1,cols:3,"x-gap":10,"y-gap":10,class:"text-center"},{default:withCtx(()=>[(openBlock(!0),createElementBlock(Fragment,null,renderList(I,V=>(openBlock(),createBlock(g,null,{default:withCtx(()=>[createVNode(s,{color:unref(categoryColors)[O],class:"w-full",onClick:z=>t.value=V},{default:withCtx(()=>[createVNode(unref(NPopover),null,{trigger:withCtx(()=>[createVNode(C,null,{default:withCtx(()=>[(openBlock(),createBlock(resolveDynamicComponent(V.renderTitle())))]),_:2},1024)]),default:withCtx(()=>[createTextVNode(" "+toDisplayString(V.title),1)]),_:2},1024)]),_:2},1032,["color","onClick"])]),_:2},1024))),256))]),_:2},1024)):(openBlock(),createBlock(d,{key:0,justify:"center"},{default:withCtx(()=>[(openBlock(!0),createElementBlock(Fragment,null,renderList(I,V=>(openBlock(),createBlock(s,{color:unref(categoryColors)[O],size:"small",onClick:z=>t.value=V},{default:withCtx(()=>[(openBlock(),createBlock(resolveDynamicComponent(V.renderTitle())))]),_:2},1032,["color","onClick"]))),256))]),_:2},1024))]),_:2},1024))),256))]),_:1}))]),_:1})]),_:1}),createVNode(k,{class:"py-2",position:"absolute"},{default:withCtx(()=>[createVNode(d,{size:0,justify:"center"},{default:withCtx(()=>[createVNode(unref(NEl),null,{default:withCtx(()=>[createVNode(unref(NText),null,{default:withCtx(()=>[createTextVNode(toDisplayString(unref(translations).maker)+": ",1)]),_:1}),createVNode(s,{href:"https://zhazha120.cn",tag:"a",text:"",type:"primary"},{default:withCtx(()=>[createTextVNode("渣渣120 ")]),_:1})]),_:1}),createVNode(b,{vertical:""}),createVNode(s,{href:"https://github.com/26F-Studio/techmino-online-dict",tag:"a",text:"",type:"primary"},{default:withCtx(()=>[createTextVNode(" Github ")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1})]),_:1},8,["theme"])}}});window.addEventListener("load",()=>{const e=createApp({render:()=>h(_sfc_main)}),n=createPinia();n.use(index),e.use(n),e.mount("#app")})});export default Ln();
